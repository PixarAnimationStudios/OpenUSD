...
static half
NormalizeHelper(GfVec2h *vec, half eps = 0.001)
{
...
static half __getitem__(const GfVec2h &self, int index) {
...
static void __setitem__(GfVec2h &self, int index, half value) {
...
static bool __contains__(const GfVec2h &self, half value) {
