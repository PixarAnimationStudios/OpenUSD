...
//!
// \class GfRange3d range3d.h "pxr/base/gf/range3d.h"
// \ingroup group_gf_BasicGeometry
// \brief Basic type: 3-dimensional floating point range.
//
// This class represents a 3-dimensional range (or interval)
