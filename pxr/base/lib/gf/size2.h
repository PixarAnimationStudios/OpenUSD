...
/*!
 * \class GfSize2 size2.h pxr/base/gf/size2.h
 * \ingroup group_gf_LinearAlgebra
 * \brief Two-dimensional array of sizes
 *
 * GfSize2 is used to represent pairs of counts.  It is based on
...
public:
    ...
    //! \brief Set to the values in a given array.
