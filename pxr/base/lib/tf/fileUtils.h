...
//
#ifndef TF_FINDFILE_H
#define TF_FINDFILE_H
 ...
 *
 * This function is called once for each directory visited by TfWalkDirs.  The
 * first parameter is the directory path; if the topmost directory passed to
 * TfWalkDirs is relative, this path will also be relative.  The second
...
/*! \brief TfRmTree error handler function.
 *
...
/*! \brief error handler to use when you want to ignore errors
 *
 * When calling TfWalkDirs/ChmodTree/RmTree and you want to ignore
 * errors, you can pass in this public error handler which will
 * ignore all the errors.
 */
void
TfWalkIgnoreErrorHandler(std::string const& path, std::string const& msg);

/*! \brief Directory tree walker.
 *
...
/*! \brief Recursively delete a directory tree rooted at \p path.
 *
