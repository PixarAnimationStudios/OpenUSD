...
public:
    ...
    /*!
     * \brief Returns memory out of the pool allocator.
     *
     * The memory returned by this routine is suitably aligned for
     * all purposes.
     */
    void* Alloc() {
        _PoolNode* node;
    ...
    /*!
     * \brief Frees up the memory previously granted by the allocator.
     *
     * The location \c ptr must have been obtained by a previous
     * call to \c Alloc(); if not, chaos will quickly ensue.
     */
