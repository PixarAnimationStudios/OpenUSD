...
void wrapVec2f()
{
    ...
    boost::python::def("GetNormalized", (Vec (*)(const Vec &v, Scalar eps))
        GfGetNormalized, pxrBaseGfWrapVec2f::GetNormalized_overloads());
    ...
    boost::python::def("IsClose", (bool (*)(const Vec &v1, const Vec &v2, double))
        GfIsClose);
    boost::python::def("Normalize", pxrBaseGfWrapVec2f::NormalizeHelper, pxrBaseGfWrapVec2f::Normalize_overloads());
        

 
    boost::python::class_<GfVec2f> cls("Vec2f", boost::python::no_init);
    cls
        .def("__init__", boost::python::make_constructor(pxrBaseGfWrapVec2f::__init__<Vec>))

        // A tag indicating that this is a GfVec class, for internal use.
        .def_readonly("__isGfVec", _true)

        .def_pickle(pxrBaseGfWrapVec2f::PickleSuite())
        ...
        .def("__len__", pxrBaseGfWrapVec2f::__len__ )
        .def("__getitem__", pxrBaseGfWrapVec2f::__getitem__ )
        .def("__getitem__", pxrBaseGfWrapVec2f::__getslice__ )
        .def("__setitem__", pxrBaseGfWrapVec2f::__setitem__ )
        .def("__setitem__", pxrBaseGfWrapVec2f::__setslice__ )
        .def("__contains__", pxrBaseGfWrapVec2f::__contains__ )
        ...
        .def("GetNormalized", &Vec::GetNormalized, pxrBaseGfWrapVec2f::VecGetNormalized_overloads())
        .def("GetProjection", &Vec::GetProjection)
        .def("Normalize", &Vec::Normalize, pxrBaseGfWrapVec2f::VecNormalize_overloads())

        .def("__repr__", pxrBaseGfWrapVec2f::__repr__)
        .def("__hash__", pxrBaseGfWrapVec2f::__hash__)
        ;
    ...
    typeObj->tp_as_buffer = &pxrBaseGfWrapVec2f::bufferProcs;
    ...
    pxrBaseGfWrapVec2f::FromPythonTuple();
