...
TestNumbers()
{
    ...
    TF_AXIOM(TfDoubleToString(-1.1111111111111113e-308,
    ...
    TF_AXIOM(TfDoubleToString(std::numeric_limits<double>::infinity(),
                              buffer, bufferSize, true));
    TF_AXIOM(strcmp(buffer, "inf") == 0);
    TF_AXIOM(TfDoubleToString(-std::numeric_limits<double>::infinity(),
                              buffer, bufferSize, true));
    TF_AXIOM(strcmp(buffer, "-inf") == 0);
    TF_AXIOM(TfDoubleToString(std::numeric_limits<double>::quiet_NaN(),
                              buffer, bufferSize, true));
    TF_AXIOM(strcmp(buffer, "nan") == 0);

    TF_AXIOM(TfDoubleToString(std::numeric_limits<double>::infinity(),
                              buffer, bufferSize, true, "Infinity", "NaN"));
