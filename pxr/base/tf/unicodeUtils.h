...
namespace TfUnicodeUtils {
    ...
    {
        return TfUnicodeUtils::Impl::IsUTF8CharXIDStart(codePoint);
    }
    ...
    {
        return TfUnicodeUtils::Impl::IsUTF8CharXIDContinue(codePoint);
    }
    ...
    {
        return TfUnicodeUtils::Impl::IsValidUTF8Identifier(sequenceStart, end);
    }
    ...
    ///
    inline std::string MakeValidUTF8Identifier(const std::string& identifier)
    {
        return TfUnicodeUtils::Impl::MakeValidUTF8Identifier(identifier);
    }
} // namespace TfUnicodeUtils
