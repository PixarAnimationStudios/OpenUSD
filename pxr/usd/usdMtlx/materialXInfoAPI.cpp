...
UsdAttribute
UsdMtlxMaterialXInfoAPI::GetMtlxinfoVersionAttr() const
{
    return GetPrim().GetAttribute(UsdMtlxTokens->mtlxinfoVersion);
}

UsdAttribute
UsdMtlxMaterialXInfoAPI::CreateMtlxinfoVersionAttr(VtValue const &defaultValue, bool writeSparsely) const
{
    return UsdSchemaBase::_CreateAttr(UsdMtlxTokens->mtlxinfoVersion,
