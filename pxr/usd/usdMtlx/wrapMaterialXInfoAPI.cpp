...
static UsdAttribute
_CreateMtlxinfoVersionAttr(UsdMtlxMaterialXInfoAPI &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateMtlxinfoVersionAttr(
...
void wrapUsdMtlxMaterialXInfoAPI()
{
    ...
    cls
        ...
        .def("GetMtlxinfoVersionAttr",
             &This::GetMtlxinfoVersionAttr)
        .def("CreateMtlxinfoVersionAttr",
             &_CreateMtlxinfoVersionAttr,
