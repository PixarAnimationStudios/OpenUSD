...
class TestUsdPmc(unittest.TestCase):
    ...
    def test_CrushUsdz(self):
        ...
        sphere_usdz = tempfile.NamedTemporaryFile(
            suffix='.usdz', delete=False).name
        sphere_crushed_usdz = tempfile.NamedTemporaryFile(
            suffix='.usdz', delete=False).name
    ...
    def test_CrushUsdc(self):
        ...
        """
        sphere_usdc = \
            tempfile.NamedTemporaryFile(suffix='.usdc', delete=False).name
    ...
    def test_CrushUsdaToUsdz(self):
        ...
        """
        sphere_usda = tempfile.NamedTemporaryFile(
            suffix='.usda', delete=False).name
        out_usdz = tempfile.NamedTemporaryFile(
            suffix='.usdz', delete=False).name
