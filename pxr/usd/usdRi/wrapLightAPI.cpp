...
struct UsdRiLightAPI_CanApplyResult : 
    public TfPyAnnotatedBoolResult<std::string>
{
    UsdRiLightAPI_CanApplyResult(bool val, std::string const &msg) :
        TfPyAnnotatedBoolResult<std::string>(val, msg) {}
};

static UsdRiLightAPI_CanApplyResult
_WrapCanApply(const UsdPrim& prim)
{
    std::string whyNot;
    bool result = UsdRiLightAPI::CanApply(prim, &whyNot);
    return UsdRiLightAPI_CanApplyResult(result, whyNot);
}
...
void wrapUsdRiLightAPI()
{
    ...
    UsdRiLightAPI_CanApplyResult::Wrap<UsdRiLightAPI_CanApplyResult>(
