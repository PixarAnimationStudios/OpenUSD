...
//
#ifndef USDLIGHTFIELD_GENERATED_SCALEATTRIBUTEAPI_H
#define USDLIGHTFIELD_GENERATED_SCALEATTRIBUTEAPI_H

/// \file usdLightField/scaleAttributeAPI.h
...
public:
    ...
    /// Construct a UsdLightFieldScaleAttributeAPI on UsdPrim \p prim .
    /// Equivalent to UsdLightFieldScaleAttributeAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdLightFieldScaleAttributeAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdLightFieldScaleAttributeAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdLightFieldScaleAttributeAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdLightFieldScaleAttributeAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Destructor.
    USDLIGHTFIELD_API
    virtual ~UsdLightFieldScaleAttributeAPI();
    ...
    /// Return a UsdLightFieldScaleAttributeAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdLightFieldScaleAttributeAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDLIGHTFIELD_API
    static UsdLightFieldScaleAttributeAPI
    ...
    /// An invalid (or empty) UsdLightFieldScaleAttributeAPI object is returned upon 
