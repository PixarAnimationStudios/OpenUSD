...
static UsdAttribute
_CreatePrimvarsSphericalBetaBetaAttr(UsdLightFieldSphericalBetaAttributeAPI &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreatePrimvarsSphericalBetaBetaAttr(
...
void wrapUsdLightFieldSphericalBetaAttributeAPI()
{
    ...
    cls
        ...
        .def("GetPrimvarsSphericalBetaBetaAttr",
             &This::GetPrimvarsSphericalBetaBetaAttr)
        .def("CreatePrimvarsSphericalBetaBetaAttr",
             &_CreatePrimvarsSphericalBetaBetaAttr,
