...
UsdMediaTokensType::UsdMediaTokensType() :
    ...
    authorship_MultipleApplyTemplate_InputNames("authorship:__INSTANCE_NAME__:inputNames", TfToken::Immortal),
    authorship_MultipleApplyTemplate_InputValues("authorship:__INSTANCE_NAME__:inputValues", TfToken::Immortal),
    ...
    allTokens({
        ...
        authorship_MultipleApplyTemplate_InputNames,
        authorship_MultipleApplyTemplate_InputValues,
