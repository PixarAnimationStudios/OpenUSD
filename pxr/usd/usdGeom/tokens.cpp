...
UsdGeomTokensType::UsdGeomTokensType() :
    ...
    allDetails("allDetails", TfToken::Immortal),
    ...
    endCapType("endCapType", TfToken::Immortal),
    ...
    jointType("jointType", TfToken::Immortal),
    ...
    noCapJoint("noCapJoint", TfToken::Immortal),
    ...
    pattern("pattern", TfToken::Immortal),
    patternPeriod("patternPeriod", TfToken::Immortal),
    patternScale("patternScale", TfToken::Immortal),
    ...
    round("round", TfToken::Immortal),
    scales("scales", TfToken::Immortal),
    screenSpacePattern("screenSpacePattern", TfToken::Immortal),
    segment("segment", TfToken::Immortal),
    shapeDetail("shapeDetail", TfToken::Immortal),
    ...
    square("square", TfToken::Immortal),
    startCapType("startCapType", TfToken::Immortal),
    ...
    DashDotLines("DashDotLines", TfToken::Immortal),
    DashDotPatternAPI("DashDotPatternAPI", TfToken::Immortal),
