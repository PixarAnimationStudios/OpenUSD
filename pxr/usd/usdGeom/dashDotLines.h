...
public:
    ...
    // SHAPEDETAIL 
    // --------------------------------------------------------------------- //
    /// The detail of the shape. If the value is "allDetails", the startCap, endCap and joint will be rendered.
    /// If the value is "noCapJoint", there is no cap at the start and end of each dash, and you can see the polyline
    /// is broken at the joint.
    ///
    /// | ||
    /// | -- | -- |
    /// | Declaration | `uniform token shapeDetail = "allDetails"` |
    /// | C++ Type | TfToken |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->Token |
    /// | \ref SdfVariability "Variability" | SdfVariabilityUniform |
    /// | \ref UsdGeomTokens "Allowed Values" | allDetails, noCapJoint |
    USDGEOM_API
    UsdAttribute GetShapeDetailAttr() const;

    /// See GetShapeDetailAttr(), and also 
    /// \ref Usd_Create_Or_Get_Property for when to use Get vs Create.
    /// If specified, author \p defaultValue as the attribute's default,
    /// sparsely (when it makes sense to do so) if \p writeSparsely is \c true -
    /// the default for \p writeSparsely is \c false.
    USDGEOM_API
    UsdAttribute CreateShapeDetailAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// when the line has pattern. This setting is valid when shapeDetail is "allDetails".
    /// 
    ///
    /// | ||
    /// | -- | -- |
...
public:
    ...
    // JOINTTYPE 
    // --------------------------------------------------------------------- //
    /// The shape of the joint for a polyline. This setting is valid when shapeDetail is "allDetails".
    ///
    /// | ||
    /// | -- | -- |
    /// | Declaration | `uniform token jointType = "round"` |
    /// | C++ Type | TfToken |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->Token |
    /// | \ref SdfVariability "Variability" | SdfVariabilityUniform |
    /// | \ref UsdGeomTokens "Allowed Values" | round |
    USDGEOM_API
    UsdAttribute GetJointTypeAttr() const;

    /// See GetJointTypeAttr(), and also 
    /// \ref Usd_Create_Or_Get_Property for when to use Get vs Create.
    /// If specified, author \p defaultValue as the attribute's default,
    /// sparsely (when it makes sense to do so) if \p writeSparsely is \c true -
    /// the default for \p writeSparsely is \c false.
    USDGEOM_API
    UsdAttribute CreateJointTypeAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
