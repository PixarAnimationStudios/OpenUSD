...
{
    boost::python::class_<UsdNprTokensType, boost::noncopyable>
    ...
    _AddToken(cls, "drawCrease", UsdNprTokens->drawCrease);
    _AddToken(cls, "drawSilhouette", UsdNprTokens->drawSilhouette);
