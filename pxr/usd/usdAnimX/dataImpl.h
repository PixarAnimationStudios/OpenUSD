...
//
#ifndef PXR_USD_PLUGIN_ANIMX_DATA_IMPL_H
#define PXR_USD_PLUGIN_ANIMX_DATA_IMPL_H
...
/// UsdAnimXData. All queries on specs and time samples are based
...
private:
    ...
    {
      std::vector<_AnimXPropertyData> properties;

      const _AnimXPropertyData* GetAnimatedProperty(const TfToken& name) const;
      TfTokenVector GetAnimatedPropertyNames() const;
      bool HasAnimatedProperty(const TfToken& name) const;
    };
...
#endif // PXR_USD_PLUGIN_ANIMX_DATA_IMPL_H
