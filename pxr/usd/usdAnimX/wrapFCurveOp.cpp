...
static UsdAttribute
_CreateAttributeNameAttr(UsdAnimXFCurveOp &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateAttributeNameAttr(
        UsdPythonToSdfType(defaultVal, SdfValueTypeNames->Token), writeSparsely);
}
        
static UsdAttribute
_CreateDataTypeAttr(UsdAnimXFCurveOp &self,
                                      object defaultVal, bool writeSparsely) {
...
void wrapUsdAnimXFCurveOp()
{
    typedef UsdAnimXFCurveOp This;
    ...
    cls
        ...
        .def("GetAttributeNameAttr",
             &This::GetAttributeNameAttr)
        .def("CreateAttributeNameAttr",
             &_CreateAttributeNameAttr,
