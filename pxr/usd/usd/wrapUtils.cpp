...
static boost::python::converter::to_python_function_t originalConverters[Usd_NumObjTypes];
                                      ...
                                      DowncastFn downcast)
{
    ...
    boost::python::converter::registration *reg =
        const_cast<boost::python::converter::registration *>(boost::python::converter::registry::query(pti));
