...
//
#ifndef CONTRIVEDTOKENSPREFIX_TOKENS_H
#define CONTRIVEDTOKENSPREFIX_TOKENS_H
...
/// \class ContrivedTokensPrefixTokensType
///
/// \link ContrivedTokensPrefixTokens \endlink provides static, efficient
...
/// correctly.
///
/// ContrivedTokensPrefixTokens also contains all of the \em allowedTokens values
/// declared for schema builtin attributes of 'token' scene description type.
/// Use ContrivedTokensPrefixTokens like so:
///
/// \code
///     gprim.GetMyTokenValuedAttr().Set(ContrivedTokensPrefixTokens->libraryToken1);
/// \endcode
struct ContrivedTokensPrefixTokensType {
    USDCONTRIVED_API ContrivedTokensPrefixTokensType();
    /// \brief "libraryToken1"
    /// 
...
/// \var ContrivedTokensPrefixTokens
///
/// A global variable with static, efficient \link TfToken TfTokens\endlink
/// for use in all public USD API.  \sa ContrivedTokensPrefixTokensType
extern USDCONTRIVED_API TfStaticData<ContrivedTokensPrefixTokensType> ContrivedTokensPrefixTokens;
