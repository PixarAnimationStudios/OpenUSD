...
/// that are text/tokens, the actual token is published and defined in \ref ContrivedTokensPrefixTokens.
/// So to set an attribute to the value "rightHanded", use ContrivedTokensPrefixTokens->rightHanded
/// as the value.
///
...
public:
    ...
    /// | \ref ContrivedTokensPrefixTokens "Allowed Values" | VariableTokenAllowed1, VariableTokenAllowed2, VariableTokenAllowed<3>, "" |
    USDCONTRIVED_API
...
public:
    ...
    /// | \ref ContrivedTokensPrefixTokens "Allowed Values" | VariableTokenArrayAllowed1, VariableTokenArrayAllowed2, VariableTokenArrayAllowed<3>, "" |
    USDCONTRIVED_API
