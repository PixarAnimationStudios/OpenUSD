...
UsdContrivedTokensType::UsdContrivedTokensType() :
    ...
    public_("public", TfToken::Immortal),
    public_MultipleApplyTemplate_("public:__INSTANCE_NAME__", TfToken::Immortal),
    public_MultipleApplyTemplate_TestAttrOne("public:__INSTANCE_NAME__:testAttrOne", TfToken::Immortal),
    public_MultipleApplyTemplate_TestAttrTwo("public:__INSTANCE_NAME__:testAttrTwo", TfToken::Immortal),
    ...
    allTokens({
        ...
        point3hArray,
        public_,
        public_MultipleApplyTemplate_,
        public_MultipleApplyTemplate_TestAttrOne,
        public_MultipleApplyTemplate_TestAttrTwo,
        quatd,
        quatdArray,
        quatf,
        quatfArray,
