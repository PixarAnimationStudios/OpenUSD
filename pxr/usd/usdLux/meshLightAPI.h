...
/// to the mesh. But, it additionally serves as a hook for plugins to attach 
/// additional properties to "mesh lights" through the creation of API schemas 
/// which are authored to auto-apply to MeshLightAPI.
