...
public:
    ...
    // SHADERID 
    // --------------------------------------------------------------------- //
    /// Default ID for the light's shader. This defines the shader ID
    /// for this light when a render context specific shader ID is not 
    /// available.
    /// \see GetShaderId() and GetShaderIdAttrForRenderContext()
    ///
    /// | ||
    /// | -- | -- |
