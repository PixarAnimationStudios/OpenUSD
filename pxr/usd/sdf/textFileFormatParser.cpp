    ...
    SdfLayerHints *hints)
{
    ...
    context.values.errorReporter =
        std::bind(Sdf_TextFileFormatParser::_ReportParseError<
    ...
    SdfLayerHints *hints)
{
    ...
    Sdf_TextFileFormatParser::PEGTL_NS::string_input<> content { std::move(layerString), ""};
    context.values.errorReporter =
        std::bind(Sdf_TextFileFormatParser::_ReportParseError<Sdf_TextFileFormatParser::PEGTL_NS::string_input<>>,
        std::ref(context), std::cref(content), std::placeholders::_1);
    bool status = false;
    try
    {
