...
#define yyparse         pathUtf8Yyparse
#define yylex           pathUtf8Yylex
#define yyerror         pathUtf8Yyerror
#define yylval          pathUtf8Yylval
#define yychar          pathUtf8Yychar
#define yydebug         pathUtf8Yydebug
#define yynerrs         pathUtf8Yynerrs
...
//--------------------------------------------------------------------
extern int pathUtf8Yylex(YYSTYPE *yylval_param, yyscan_t yyscanner);
static void pathUtf8Yyerror(Sdf_PathParserContext *context, const char *msg);

#define yyscanner context->scanner


/* Line 371 of yacc.c  */
#line 103 "pathUtf8.tab.cpp"
...
static const char *const yytname[] =
{
  ...
  "expression_path", "whitespace_opt", YY_NULL
};
#endif
...
/* Line 2050 of yacc.c  */
#line 280 "pathUtf8.yy"


static void 
pathUtf8Yyerror(Sdf_PathParserContext *context, const char *msg) 
{
    TF_AXIOM(context);
