...
UsdLuxTokensType::UsdLuxTokensType() :
    ...
    collectionFilterLinkExpansionRule("collection:filterLink:expansionRule", TfToken::Immortal),
    collectionFilterLinkIncludeRoot("collection:filterLink:includeRoot", TfToken::Immortal),
    collectionLightLinkExpansionRule("collection:lightLink:expansionRule", TfToken::Immortal),
    collectionLightLinkIncludeRoot("collection:lightLink:includeRoot", TfToken::Immortal),
    collectionShadowLinkExpansionRule("collection:shadowLink:expansionRule", TfToken::Immortal),
    ...
    allTokens({
        ...
        angular,
        automatic,
        collectionFilterLinkExpansionRule,
        collectionFilterLinkIncludeRoot,
        collectionLightLinkExpansionRule,
        collectionLightLinkIncludeRoot,
        collectionShadowLinkExpansionRule,
