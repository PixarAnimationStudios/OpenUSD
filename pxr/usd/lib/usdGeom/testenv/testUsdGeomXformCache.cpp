                      ...
                      GfMatrix4d xform)
{
    ...
    TF_VERIFY(not xfCache.TransformMightBeTimeVarying(stage->GetPseudoRoot()));
    TF_VERIFY(not xfCache.GetResetXformStack(stage->GetPseudoRoot()));
    ...
    TF_VERIFY(not xfCache.GetResetXformStack(root));
    ...
    TF_VERIFY(not xfCache.GetResetXformStack(foo));
    ...
    TF_VERIFY(not xfCache.GetResetXformStack(fooBarBaz));
    ...
    TF_VERIFY(not xfCache.GetResetXformStack(bar));
    ...
    ctm = xfCache.GetLocalToWorldTransform(bar);
    TF_VERIFY(not outsideWorldPathLocalErrorMark.IsClean());
    ...
    ctm = xfCache.GetParentToWorldTransform(bar);
    TF_VERIFY(not outsideWorldPathParentErrorMark.IsClean());
    TF_VERIFY(ctm == GfMatrix4d(1),
    ...
    TF_VERIFY(not badWorldPathErrorMark.IsClean());
