...
public:
    ...
    /// This information is stored by adding "PrimvarsAPI" to the 
    /// token-valued, listOp metadata \em apiSchemas on the prim.
    /// 
    /// \return A valid UsdGeomPrimvarsAPI object is returned upon success. 
    /// An invalid (or empty) UsdGeomPrimvarsAPI object is returned upon 
