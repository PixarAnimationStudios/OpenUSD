...
/// 
///
class UsdHydraLookAPI : public UsdAPISchemaBase
{
public:
    ...
    /// 
    /// \return A valid UsdHydraLookAPI object is returned upon success. 
    /// An invalid (or empty) UsdHydraLookAPI object is returned upon 
