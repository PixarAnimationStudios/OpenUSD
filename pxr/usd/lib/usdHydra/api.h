...
#       define USDHYDRA_API_TEMPLATE_CLASS(...) extern template class USDHYDRA_API __VA_ARGS__
#       define USDHYDRA_API_TEMPLATE_STRUCT(...) extern template struct USDHYDRA_API __VA_ARGS__
#   endif
