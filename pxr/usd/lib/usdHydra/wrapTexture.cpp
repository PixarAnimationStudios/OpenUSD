...
static UsdAttribute
_CreateFilenameAttr(UsdHydraTexture &self,
...
static UsdAttribute
_CreateFrameAttr(UsdHydraTexture &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateTextureMemoryAttr(UsdHydraTexture &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateTextureMemoryAttr(
        UsdPythonToSdfType(defaultVal, SdfValueTypeNames->Float), writeSparsely);
}

void wrapUsdHydraTexture()
{
    typedef UsdHydraTexture This;
