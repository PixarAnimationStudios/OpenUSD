...
static UsdAttribute
_CreateRiPortalIntensityAttr(UsdRiRiLightPortalAPI &self,
...
static UsdAttribute
_CreateRiPortalTintAttr(UsdRiRiLightPortalAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
void wrapUsdRiRiLightPortalAPI()
{
    typedef UsdRiRiLightPortalAPI This;

    class_<This, bases<UsdSchemaBase> >
        cls("RiLightPortalAPI");
