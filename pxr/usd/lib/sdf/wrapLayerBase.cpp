...
void wrapLayerBase()
{
    typedef SdfLayerBase This;
    typedef SdfLayerBasePtr ThisPtr;

    class_<This, ThisPtr, boost::noncopyable>("LayerBase", no_init)
...
{
    template<> 
    const volatile SdfLayerBase* 
        get_pointer(const volatile SdfLayerBase* p)
    { 
        return p; 
    }
}
