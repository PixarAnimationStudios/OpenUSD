...
#define yyparse         layerIdentifierYyparse
#define yylex           layerIdentifierYylex
#define yyerror         layerIdentifierYyerror
#define yylval          layerIdentifierYylval
#define yychar          layerIdentifierYychar
#define yydebug         layerIdentifierYydebug
#define yynerrs         layerIdentifierYynerrs
...
{
      10,     0,    -1,    11,    -1,    11,     6,    12,    -1,     3,
      -1,    13,    -1,    13,     7,    12,    -1,     4,     8,     5,
      -1,     4,     8,     4,    -1,     4,     8,    -1
};
...
{
  "$end", "error", "$undefined", "TOK_LAYER_PATH", "TOK_IDENTIFIER",
  "TOK_VALUE", "'?'", "'&'", "'='", "$accept", "identifier", "layer_path",
...
{
       0,   256,   257,   258,   259,   260,    63,    38,    61
};
# endif
...
{
      11,    12,     1,     4,     5,     6,     0,    13,     9,    10
};

static const yytype_int8 yycheck[] =
{
       4,     5,     3,     0,     6,     4,    -1,    10,     8,     7
};
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, Sdf_LayerIdentifierParserContext *context)
#else
static void
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, Sdf_LayerIdentifierParserContext *context)
#else
static void
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, Sdf_LayerIdentifierParserContext *context)
#else
static void
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, Sdf_LayerIdentifierParserContext *context)
#else
static void
...
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int yyparse (Sdf_LayerIdentifierParserContext *context);
#else
int yyparse ();
#endif
#endif /* ! YYPARSE_PARAM */
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (Sdf_LayerIdentifierParserContext *context)
#else
int
yyparse (context)
    Sdf_LayerIdentifierParserContext *context;
