...
public:
    ...
    /// type PublicMultipleApplyAPI. If so, it stores the instance name of
...
private:
    ...
    // This override returns true since UsdContrivedPublicMultipleApplyAPI is an 
    // applied API schema.
    USDCONTRIVED_API
    virtual bool _IsAppliedAPISchema() const override;

    // This override returns true since UsdContrivedPublicMultipleApplyAPI is a multiple-
    // apply API schema.
    USDCONTRIVED_API
