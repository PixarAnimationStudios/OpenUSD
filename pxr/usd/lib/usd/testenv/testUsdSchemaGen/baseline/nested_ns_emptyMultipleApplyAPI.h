...
private:
    ...
    // This override returns true since UsdContrivedEmptyMultipleApplyAPI is an 
    // applied API schema.
    USDCONTRIVED_API
    virtual bool _IsAppliedAPISchema() const override;

    // This override returns true since UsdContrivedEmptyMultipleApplyAPI is a multiple-
    // apply API schema.
    USDCONTRIVED_API
