...
/// \file pxr/usd/usdContrived/tokens.h
...
/// \brief <b>UsdContrivedTokens</b> provides static, efficient TfToken's for
...
TF_DECLARE_PUBLIC_TOKENS(UsdContrivedTokens, USDCONTRIVED_TOKENS);
