...
/// \li <b>clipTemplateAssetPath</b> -  A template string representing a set of assets. This string can be of two forms: path/basename.###.usd and path/basename.##.##.usd. In either case, the number of hash marks in each section is variable. These control the amount of padding USD will supply when looking up  the assets. For instance, a value of 'foo.###.usd',  with clipTemplateStartTime=11, clipTemplateEndTime=15, and clipTemplateStride=1: USD will look for: foo.11.usd, foo.12.usd, foo.13.usd, foo.14.usd, foo.15.usd,  foo.011.usd, foo.012.usd, foo.013.usd, foo.014.usd and foo.015.usd. 
