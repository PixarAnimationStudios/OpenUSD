...
#       define USDUTILS_API_TEMPLATE_CLASS(...) extern template class USDUTILS_API __VA_ARGS__
#       define USDUTILS_API_TEMPLATE_STRUCT(...) extern template struct USDUTILS_API __VA_ARGS__
#   endif
