...
static UsdAttribute
_CreateMarkupStringAttr(UsdTextMarkupText &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateMarkupStringAttr(
...
static UsdAttribute
_CreateRendererAttr(UsdTextMarkupText &self,
                                      object defaultVal, bool writeSparsely) {
...
void wrapUsdTextMarkupText()
{
    ...
    cls
        ...
        .def("GetMarkupStringAttr",
             &This::GetMarkupStringAttr)
        .def("CreateMarkupStringAttr",
             &_CreateMarkupStringAttr,
