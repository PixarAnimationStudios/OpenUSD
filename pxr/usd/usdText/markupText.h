...
///
/// Class for multiple lines or multiple styles text.
///
...
public:
    ...
    // MARKUPSTRING 
    // --------------------------------------------------------------------- //
    /// The markup string data.
    ///
    /// | ||
    /// | -- | -- |
    /// | Declaration | `uniform string markupString` |
    /// | C++ Type | std::string |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->String |
    /// | \ref SdfVariability "Variability" | SdfVariabilityUniform |
    USDTEXT_API
    UsdAttribute GetMarkupStringAttr() const;

    /// See GetMarkupStringAttr(), and also 
    /// \ref Usd_Create_Or_Get_Property for when to use Get vs Create.
    /// If specified, author \p defaultValue as the attribute's default,
    /// sparsely (when it makes sense to do so) if \p writeSparsely is \c true -
    /// the default for \p writeSparsely is \c false.
    USDTEXT_API
    UsdAttribute CreateMarkupStringAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
...
public:
    ...
    /// | ||
    /// | -- | -- |
    /// | Declaration | `uniform token markupLanguage = "noMarkup"` |
    /// | C++ Type | TfToken |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->Token |
    /// | \ref SdfVariability "Variability" | SdfVariabilityUniform |
    /// | \ref UsdTextTokens "Allowed Values" | noMarkup, mtext |
    USDTEXT_API
...
public:
    ...
    // TEXTMETRICSUNIT 
    // --------------------------------------------------------------------- //
    /// The unit for the text related metrics, such as the unit of textHeight.
    ///
    /// | ||
    /// | -- | -- |
    /// | Declaration | `uniform token primvars:textMetricsUnit = "worldUnit"` |
    /// | C++ Type | TfToken |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->Token |
    /// | \ref SdfVariability "Variability" | SdfVariabilityUniform |
...
public:
    ...
    // RENDERER 
    // --------------------------------------------------------------------- //
    /// The id of the textRenderer.
    ///
    /// | ||
    /// | -- | -- |
    /// | Declaration | `uniform string renderer = ""` |
    /// | C++ Type | std::string |
    /// | \ref Usd_Datatypes "Usd Type" | SdfValueTypeNames->String |
    /// | \ref SdfVariability "Variability" | SdfVariabilityUniform |
    USDTEXT_API
    UsdAttribute GetRendererAttr() const;

    /// See GetRendererAttr(), and also 
    /// \ref Usd_Create_Or_Get_Property for when to use Get vs Create.
    /// If specified, author \p defaultValue as the attribute's default,
    /// sparsely (when it makes sense to do so) if \p writeSparsely is \c true -
    /// the default for \p writeSparsely is \c false.
    USDTEXT_API
    UsdAttribute CreateRendererAttr(VtValue const &defaultValue = VtValue(), bool writeSparsely=false) const;
