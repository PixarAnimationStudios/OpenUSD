...
static UsdAttribute
_CreateTextDataAttr(UsdTextSimpleText &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateTextDataAttr(
        UsdPythonToSdfType(defaultVal, SdfValueTypeNames->String), writeSparsely);
}
        
static UsdAttribute
_CreateBackgroundColorAttr(UsdTextSimpleText &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateBackgroundOpacityAttr(UsdTextSimpleText &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateTextMetricsUnitAttr(UsdTextSimpleText &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateRendererAttr(UsdTextSimpleText &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateRendererAttr(
        UsdPythonToSdfType(defaultVal, SdfValueTypeNames->String), writeSparsely);
}

static std::string
_Repr(const UsdTextSimpleText &self)
{
    std::string primRepr = TfPyRepr(self.GetPrim());
    return TfStringPrintf(
        "UsdText.SimpleText(%s)",
        primRepr.c_str());
}

} // anonymous namespace

void wrapUsdTextSimpleText()
{
    typedef UsdTextSimpleText This;
    ...
    cls
        ...
        .def("GetTextDataAttr",
             &This::GetTextDataAttr)
        .def("CreateTextDataAttr",
             &_CreateTextDataAttr,
        ...
        .def("GetRendererAttr",
             &This::GetRendererAttr)
        .def("CreateRendererAttr",
             &_CreateRendererAttr,
             (arg("defaultValue")=object(),
              arg("writeSparsely")=false))
