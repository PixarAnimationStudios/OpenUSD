...
static UsdAttribute
_CreateOffsetAttr(UsdTextColumnStyle &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateBlockAlignmentAttr(UsdTextColumnStyle &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateBlockAlignmentAttr(
        UsdPythonToSdfType(defaultVal, SdfValueTypeNames->Token), writeSparsely);
}
        
static UsdAttribute
_CreateDirectionAttr(UsdTextColumnStyle &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateLinesFlowDirectionAttr(UsdTextColumnStyle &self,
                                      object defaultVal, bool writeSparsely) {
    return self.CreateLinesFlowDirectionAttr(
        UsdPythonToSdfType(defaultVal, SdfValueTypeNames->Token), writeSparsely);
}
...
void wrapUsdTextColumnStyle()
{
    ...
    cls
        ...
        .def("GetBlockAlignmentAttr",
             &This::GetBlockAlignmentAttr)
        .def("CreateBlockAlignmentAttr",
             &_CreateBlockAlignmentAttr,
             (arg("defaultValue")=object(),
              arg("writeSparsely")=false))
        ...
        .def("GetLinesFlowDirectionAttr",
             &This::GetLinesFlowDirectionAttr)
        .def("CreateLinesFlowDirectionAttr",
             &_CreateLinesFlowDirectionAttr,
             (arg("defaultValue")=object(),
              arg("writeSparsely")=false))
