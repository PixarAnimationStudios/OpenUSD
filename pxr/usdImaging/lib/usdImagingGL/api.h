...
//
#ifndef USDIMAGINGGL_API_H
#define USDIMAGINGGL_API_H
...
#       define USDIMAGINGGL_API_TEMPLATE_CLASS(...) extern template class USDIMAGINGGL_API __VA_ARGS__
#       define USDIMAGINGGL_API_TEMPLATE_STRUCT(...) extern template struct USDIMAGINGGL_API __VA_ARGS__
#   endif
