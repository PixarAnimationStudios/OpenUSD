...
# Test overlapping planes.
def _testOverlappingPlanes(appController):
    _setBackgroundColorAction(appController, appController._ui.actionGrey_Dark)
    appController._takeShot("depthPriority.png")

# Test Order Independent Transparency in UsdView
def testUsdviewInputFunction(appController):
    _modifySettings(appController)
    _testOverlappingPlanes(appController)
