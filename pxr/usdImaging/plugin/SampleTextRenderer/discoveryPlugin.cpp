...
const NdrStringVec& 
SampleTextRendererDiscoveryPlugin::GetSearchURIs() const
{
...
SampleTextRendererDiscoveryPlugin::DiscoverNodes(const Context &context)
{
...
NDR_REGISTER_DISCOVERY_PLUGIN(SampleTextRendererDiscoveryPlugin);
