...
#ifndef HD_USD_WRITER_POINTS_H
#define HD_USD_WRITER_POINTS_H
...
///
class HdUsdWriterPoints : public HdUsdWriterPointBased<HdPoints>
{
public:
    HF_MALLOC_TAG_NEW("new HdUsdWriterPoints");

    /// HdUsdWriterPoints constructor.
    ///   \param id The scene-graph path to this HdUsdWriterPoints.
    HDUSDWRITER_API
    explicit HdUsdWriterPoints(SdfPath const& id);

    /// HdUsdWriterPoints destructor.
    HDUSDWRITER_API
    ~HdUsdWriterPoints() override = default;
    ...
    ///   \return The initial dirty state this HdUsdWriterPoints wants to query.
    HDUSDWRITER_API
...
protected:
    ...
    HdUsdWriterPoints(const HdUsdWriterPoints&) = delete;
    HdUsdWriterPoints& operator=(const HdUsdWriterPoints&) = delete;
};
