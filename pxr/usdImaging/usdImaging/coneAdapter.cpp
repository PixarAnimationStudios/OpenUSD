...
namespace pxrUsdImagingUsdImagingConeAdapter {
...
} // pxrUsdImagingUsdImagingConeAdapter
                                     ...
                                     UsdTimeCode time)
{
    ...
    GfMatrix4d scale = pxrUsdImagingUsdImagingConeAdapter::_GetImplicitGeomScaleTransform(prim, time);
