...
//
#ifndef PXR_USD_IMAGING_USD_IMAGING_MARKUP_TEXT_ADAPTER_H
#define PXR_USD_IMAGING_USD_IMAGING_MARKUP_TEXT_ADAPTER_H

/// \file usdImaging/markupTextAdapter.h
...
/// \class UsdImagingMarkupTextAdapter
///
/// Delegate support for UsdTextMarkupText.
///
class UsdImagingMarkupTextAdapter : public UsdImagingGprimAdapter 
{
public:
    using BaseAdapter = UsdImagingGprimAdapter;

    UsdImagingMarkupTextAdapter()
        : UsdImagingGprimAdapter()
        , _textGeometryCache(0)
    {}

    USDIMAGING_API
    ~UsdImagingMarkupTextAdapter() override;
...
protected:
    ...
    bool _GenerateMarkupTextGeometries(UsdPrim const& prim,
                                       UsdTimeCode time,
...
#endif // PXR_USD_IMAGING_USD_IMAGING_MARKUP_TEXT_ADAPTER_H
