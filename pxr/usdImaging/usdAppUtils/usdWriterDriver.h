...
#ifndef PXR_USD_IMAGING_USD_APP_UTILS_USD_WRITER_DRIVER_H
#define PXR_USD_IMAGING_USD_APP_UTILS_USD_WRITER_DRIVER_H

/// \file usdAppUtils/usdWriterDriver.h
...
class UsdAppUtilsUsdWriterDriver
{
public:
    USDAPPUTILS_API
