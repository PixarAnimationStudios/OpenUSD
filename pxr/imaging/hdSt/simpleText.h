...
//
#ifndef PXR_IMAGING_HD_ST_SIMPLE_TEXT_H
#define PXR_IMAGING_HD_ST_SIMPLE_TEXT_H
...
/// font file. The geometry is provided by the scene delegate. The RPrim will use the shader to 
/// form the curves outline of each character. 
///
class HdStSimpleText final: public HdSimpleText
{
public:
    HF_MALLOC_TAG_NEW("new HdStSimpleText");

    HDST_API
    HdStSimpleText(SdfPath const& id);

    HDST_API
    ~HdStSimpleText() override;
...
protected:
    ...
    void _UpdateCurveDrawItemGeometricShader(
...
#endif // PXR_IMAGING_HD_ST_SIMPLE_TEXT_H
