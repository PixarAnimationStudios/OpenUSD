...
public:
    ...
    HGIMETAL_API
    virtual ~HgiMetalMemberShaderSection();
...
private:
    ...
    const HgiMetalSamplerShaderSection* _samplerShaderSectionDependency;
...
private:
    std::unique_ptr<std::string> _addressSpace;
    bool _isPointer;
};
