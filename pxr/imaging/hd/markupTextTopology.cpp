...
HdMarkupTextTopology::HdMarkupTextTopology()
    : HdTopology()
    , _pointCount(0)
    , _decorationCount(0)
{
    HD_PERF_COUNTER_INCR(HdPerfTokens->markupTextTopology);
}
HdMarkupTextTopology::HdMarkupTextTopology(size_t pointCount, size_t decorationCount)
  : HdTopology(), _pointCount(pointCount), _decorationCount(decorationCount)
{
    HD_PERF_COUNTER_INCR(HdPerfTokens->markupTextTopology);
}

HdMarkupTextTopology::HdMarkupTextTopology(const HdMarkupTextTopology& src)
...
HdMarkupTextTopology::~HdMarkupTextTopology()
{
    HD_PERF_COUNTER_DECR(HdPerfTokens->markupTextTopology);
}

bool
HdMarkupTextTopology::operator==(HdMarkupTextTopology const &other) const
{
    HD_TRACE_FUNCTION();
...
HdTopology::ID
HdMarkupTextTopology::ComputeHash() const
{
    HD_TRACE_FUNCTION();
...
std::ostream&
operator << (std::ostream &out, HdMarkupTextTopology const &topo)
{
