...
#define HDIMAGESHADER_SCHEMA_TOKENS \
    (imageShader) \
    (enabled) \
    (priority) \
    (filePath) \
...
public:
    ...
    /// Returns an HdDataSourceLocator (relative to the prim-level data source)
    /// where the enabled data source can be found.
    ...
    /// Returns an HdDataSourceLocator (relative to the prim-level data source)
    /// where the priority data source can be found.
    /// This is often useful for checking intersection against the
    /// HdDataSourceLocatorSet sent with HdDataSourceObserver::PrimsDirtied.
    HD_API
    ...
    /// Returns an HdDataSourceLocator (relative to the prim-level data source)
    /// where the filepath data source can be found.
    /// This is often useful for checking intersection against the
    /// HdDataSourceLocatorSet sent with HdDataSourceObserver::PrimsDirtied.
    HD_API
    ...
    /// Returns an HdDataSourceLocator (relative to the prim-level data source)
    /// where the constants data source can be found.
    /// This is often useful for checking intersection against the
    /// HdDataSourceLocatorSet sent with HdDataSourceObserver::PrimsDirtied.
    HD_API
