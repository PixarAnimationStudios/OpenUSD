...
static bool loadSymbols()
{
    ...
    GARCH_GL_AMD_blend_minmax_factor = hasExt("GL_AMD_blend_minmax_factor", numexts, exts);
    GARCH_GL_AMD_conservative_depth = hasExt("GL_AMD_conservative_depth", numexts, exts);
    GARCH_GL_AMD_debug_output = hasExt("GL_AMD_debug_output", numexts, exts);
    GARCH_GL_AMD_depth_clamp_separate = hasExt("GL_AMD_depth_clamp_separate", numexts, exts);
    GARCH_GL_AMD_draw_buffers_blend = hasExt("GL_AMD_draw_buffers_blend", numexts, exts);
    GARCH_GL_AMD_framebuffer_multisample_advanced = hasExt("GL_AMD_framebuffer_multisample_advanced", numexts, exts);
    GARCH_GL_AMD_framebuffer_sample_positions = hasExt("GL_AMD_framebuffer_sample_positions", numexts, exts);
    GARCH_GL_AMD_gcn_shader = hasExt("GL_AMD_gcn_shader", numexts, exts);
    GARCH_GL_AMD_gpu_shader_half_float = hasExt("GL_AMD_gpu_shader_half_float", numexts, exts);
    GARCH_GL_AMD_gpu_shader_int16 = hasExt("GL_AMD_gpu_shader_int16", numexts, exts);
    GARCH_GL_AMD_gpu_shader_int64 = hasExt("GL_AMD_gpu_shader_int64", numexts, exts);
    GARCH_GL_AMD_interleaved_elements = hasExt("GL_AMD_interleaved_elements", numexts, exts);
    GARCH_GL_AMD_multi_draw_indirect = hasExt("GL_AMD_multi_draw_indirect", numexts, exts);
    GARCH_GL_AMD_name_gen_delete = hasExt("GL_AMD_name_gen_delete", numexts, exts);
    GARCH_GL_AMD_occlusion_query_event = hasExt("GL_AMD_occlusion_query_event", numexts, exts);
    GARCH_GL_AMD_performance_monitor = hasExt("GL_AMD_performance_monitor", numexts, exts);
    GARCH_GL_AMD_pinned_memory = hasExt("GL_AMD_pinned_memory", numexts, exts);
    GARCH_GL_AMD_query_buffer_object = hasExt("GL_AMD_query_buffer_object", numexts, exts);
    GARCH_GL_AMD_sample_positions = hasExt("GL_AMD_sample_positions", numexts, exts);
    GARCH_GL_AMD_seamless_cubemap_per_texture = hasExt("GL_AMD_seamless_cubemap_per_texture", numexts, exts);
    GARCH_GL_AMD_shader_atomic_counter_ops = hasExt("GL_AMD_shader_atomic_counter_ops", numexts, exts);
    GARCH_GL_AMD_shader_ballot = hasExt("GL_AMD_shader_ballot", numexts, exts);
    GARCH_GL_AMD_shader_gpu_shader_half_float_fetch = hasExt("GL_AMD_shader_gpu_shader_half_float_fetch", numexts, exts);
    GARCH_GL_AMD_shader_image_load_store_lod = hasExt("GL_AMD_shader_image_load_store_lod", numexts, exts);
    GARCH_GL_AMD_shader_stencil_export = hasExt("GL_AMD_shader_stencil_export", numexts, exts);
    GARCH_GL_AMD_shader_trinary_minmax = hasExt("GL_AMD_shader_trinary_minmax", numexts, exts);
    GARCH_GL_AMD_shader_explicit_vertex_parameter = hasExt("GL_AMD_shader_explicit_vertex_parameter", numexts, exts);
    GARCH_GL_AMD_sparse_texture = hasExt("GL_AMD_sparse_texture", numexts, exts);
    GARCH_GL_AMD_stencil_operation_extended = hasExt("GL_AMD_stencil_operation_extended", numexts, exts);
    GARCH_GL_AMD_texture_gather_bias_lod = hasExt("GL_AMD_texture_gather_bias_lod", numexts, exts);
    GARCH_GL_AMD_texture_texture4 = hasExt("GL_AMD_texture_texture4", numexts, exts);
    GARCH_GL_AMD_transform_feedback3_lines_triangles = hasExt("GL_AMD_transform_feedback3_lines_triangles", numexts, exts);
    GARCH_GL_AMD_transform_feedback4 = hasExt("GL_AMD_transform_feedback4", numexts, exts);
    GARCH_GL_AMD_vertex_shader_layer = hasExt("GL_AMD_vertex_shader_layer", numexts, exts);
    GARCH_GL_AMD_vertex_shader_tessellator = hasExt("GL_AMD_vertex_shader_tessellator", numexts, exts);
    GARCH_GL_AMD_vertex_shader_viewport_index = hasExt("GL_AMD_vertex_shader_viewport_index", numexts, exts);
    GARCH_GL_APPLE_aux_depth_stencil = hasExt("GL_APPLE_aux_depth_stencil", numexts, exts);
    GARCH_GL_APPLE_client_storage = hasExt("GL_APPLE_client_storage", numexts, exts);
    GARCH_GL_APPLE_element_array = hasExt("GL_APPLE_element_array", numexts, exts);
    GARCH_GL_APPLE_fence = hasExt("GL_APPLE_fence", numexts, exts);
    GARCH_GL_APPLE_float_pixels = hasExt("GL_APPLE_float_pixels", numexts, exts);
    GARCH_GL_APPLE_flush_buffer_range = hasExt("GL_APPLE_flush_buffer_range", numexts, exts);
    GARCH_GL_APPLE_object_purgeable = hasExt("GL_APPLE_object_purgeable", numexts, exts);
    GARCH_GL_APPLE_rgb_422 = hasExt("GL_APPLE_rgb_422", numexts, exts);
    GARCH_GL_APPLE_row_bytes = hasExt("GL_APPLE_row_bytes", numexts, exts);
    GARCH_GL_APPLE_specular_vector = hasExt("GL_APPLE_specular_vector", numexts, exts);
    GARCH_GL_APPLE_texture_range = hasExt("GL_APPLE_texture_range", numexts, exts);
    GARCH_GL_APPLE_transform_hint = hasExt("GL_APPLE_transform_hint", numexts, exts);
    GARCH_GL_APPLE_vertex_array_object = hasExt("GL_APPLE_vertex_array_object", numexts, exts);
    GARCH_GL_APPLE_vertex_array_range = hasExt("GL_APPLE_vertex_array_range", numexts, exts);
    GARCH_GL_APPLE_vertex_program_evaluators = hasExt("GL_APPLE_vertex_program_evaluators", numexts, exts);
    GARCH_GL_APPLE_ycbcr_422 = hasExt("GL_APPLE_ycbcr_422", numexts, exts);
    GARCH_GL_ARB_ES2_compatibility = hasExt("GL_ARB_ES2_compatibility", numexts, exts);
    GARCH_GL_ARB_ES3_1_compatibility = hasExt("GL_ARB_ES3_1_compatibility", numexts, exts);
    GARCH_GL_ARB_ES3_2_compatibility = hasExt("GL_ARB_ES3_2_compatibility", numexts, exts);
    GARCH_GL_ARB_ES3_compatibility = hasExt("GL_ARB_ES3_compatibility", numexts, exts);
    GARCH_GL_ARB_arrays_of_arrays = hasExt("GL_ARB_arrays_of_arrays", numexts, exts);
    GARCH_GL_ARB_base_instance = hasExt("GL_ARB_base_instance", numexts, exts);
    GARCH_GL_ARB_bindless_texture = hasExt("GL_ARB_bindless_texture", numexts, exts);
    GARCH_GL_ARB_blend_func_extended = hasExt("GL_ARB_blend_func_extended", numexts, exts);
    GARCH_GL_ARB_buffer_storage = hasExt("GL_ARB_buffer_storage", numexts, exts);
    GARCH_GL_ARB_cl_event = hasExt("GL_ARB_cl_event", numexts, exts);
    GARCH_GL_ARB_clear_buffer_object = hasExt("GL_ARB_clear_buffer_object", numexts, exts);
    GARCH_GL_ARB_clear_texture = hasExt("GL_ARB_clear_texture", numexts, exts);
    GARCH_GL_ARB_clip_control = hasExt("GL_ARB_clip_control", numexts, exts);
    GARCH_GL_ARB_color_buffer_float = hasExt("GL_ARB_color_buffer_float", numexts, exts);
    GARCH_GL_ARB_compatibility = hasExt("GL_ARB_compatibility", numexts, exts);
    GARCH_GL_ARB_compressed_texture_pixel_storage = hasExt("GL_ARB_compressed_texture_pixel_storage", numexts, exts);
    GARCH_GL_ARB_compute_shader = hasExt("GL_ARB_compute_shader", numexts, exts);
    GARCH_GL_ARB_compute_variable_group_size = hasExt("GL_ARB_compute_variable_group_size", numexts, exts);
    GARCH_GL_ARB_conditional_render_inverted = hasExt("GL_ARB_conditional_render_inverted", numexts, exts);
    GARCH_GL_ARB_conservative_depth = hasExt("GL_ARB_conservative_depth", numexts, exts);
    GARCH_GL_ARB_copy_buffer = hasExt("GL_ARB_copy_buffer", numexts, exts);
    GARCH_GL_ARB_copy_image = hasExt("GL_ARB_copy_image", numexts, exts);
    GARCH_GL_ARB_cull_distance = hasExt("GL_ARB_cull_distance", numexts, exts);
    GARCH_GL_ARB_debug_output = hasExt("GL_ARB_debug_output", numexts, exts);
    GARCH_GL_ARB_depth_buffer_float = hasExt("GL_ARB_depth_buffer_float", numexts, exts);
    GARCH_GL_ARB_depth_clamp = hasExt("GL_ARB_depth_clamp", numexts, exts);
    GARCH_GL_ARB_depth_texture = hasExt("GL_ARB_depth_texture", numexts, exts);
    GARCH_GL_ARB_derivative_control = hasExt("GL_ARB_derivative_control", numexts, exts);
    GARCH_GL_ARB_direct_state_access = hasExt("GL_ARB_direct_state_access", numexts, exts);
    GARCH_GL_ARB_draw_buffers = hasExt("GL_ARB_draw_buffers", numexts, exts);
    GARCH_GL_ARB_draw_buffers_blend = hasExt("GL_ARB_draw_buffers_blend", numexts, exts);
    GARCH_GL_ARB_draw_elements_base_vertex = hasExt("GL_ARB_draw_elements_base_vertex", numexts, exts);
    GARCH_GL_ARB_draw_indirect = hasExt("GL_ARB_draw_indirect", numexts, exts);
    GARCH_GL_ARB_draw_instanced = hasExt("GL_ARB_draw_instanced", numexts, exts);
    GARCH_GL_ARB_enhanced_layouts = hasExt("GL_ARB_enhanced_layouts", numexts, exts);
    GARCH_GL_ARB_explicit_attrib_location = hasExt("GL_ARB_explicit_attrib_location", numexts, exts);
    GARCH_GL_ARB_explicit_uniform_location = hasExt("GL_ARB_explicit_uniform_location", numexts, exts);
    GARCH_GL_ARB_fragment_coord_conventions = hasExt("GL_ARB_fragment_coord_conventions", numexts, exts);
    GARCH_GL_ARB_fragment_layer_viewport = hasExt("GL_ARB_fragment_layer_viewport", numexts, exts);
    GARCH_GL_ARB_fragment_program = hasExt("GL_ARB_fragment_program", numexts, exts);
    GARCH_GL_ARB_fragment_program_shadow = hasExt("GL_ARB_fragment_program_shadow", numexts, exts);
    GARCH_GL_ARB_fragment_shader = hasExt("GL_ARB_fragment_shader", numexts, exts);
    GARCH_GL_ARB_fragment_shader_interlock = hasExt("GL_ARB_fragment_shader_interlock", numexts, exts);
    GARCH_GL_ARB_framebuffer_no_attachments = hasExt("GL_ARB_framebuffer_no_attachments", numexts, exts);
    GARCH_GL_ARB_framebuffer_object = hasExt("GL_ARB_framebuffer_object", numexts, exts);
    GARCH_GL_ARB_framebuffer_sRGB = hasExt("GL_ARB_framebuffer_sRGB", numexts, exts);
    GARCH_GL_ARB_geometry_shader4 = hasExt("GL_ARB_geometry_shader4", numexts, exts);
    GARCH_GL_ARB_get_program_binary = hasExt("GL_ARB_get_program_binary", numexts, exts);
    GARCH_GL_ARB_get_texture_sub_image = hasExt("GL_ARB_get_texture_sub_image", numexts, exts);
    GARCH_GL_ARB_gl_spirv = hasExt("GL_ARB_gl_spirv", numexts, exts);
    GARCH_GL_ARB_gpu_shader5 = hasExt("GL_ARB_gpu_shader5", numexts, exts);
    GARCH_GL_ARB_gpu_shader_fp64 = hasExt("GL_ARB_gpu_shader_fp64", numexts, exts);
    GARCH_GL_ARB_gpu_shader_int64 = hasExt("GL_ARB_gpu_shader_int64", numexts, exts);
    GARCH_GL_ARB_half_float_pixel = hasExt("GL_ARB_half_float_pixel", numexts, exts);
    GARCH_GL_ARB_half_float_vertex = hasExt("GL_ARB_half_float_vertex", numexts, exts);
    GARCH_GL_ARB_imaging = hasExt("GL_ARB_imaging", numexts, exts);
    GARCH_GL_ARB_indirect_parameters = hasExt("GL_ARB_indirect_parameters", numexts, exts);
    GARCH_GL_ARB_instanced_arrays = hasExt("GL_ARB_instanced_arrays", numexts, exts);
    GARCH_GL_ARB_internalformat_query = hasExt("GL_ARB_internalformat_query", numexts, exts);
    GARCH_GL_ARB_internalformat_query2 = hasExt("GL_ARB_internalformat_query2", numexts, exts);
    GARCH_GL_ARB_invalidate_subdata = hasExt("GL_ARB_invalidate_subdata", numexts, exts);
    GARCH_GL_ARB_map_buffer_alignment = hasExt("GL_ARB_map_buffer_alignment", numexts, exts);
    GARCH_GL_ARB_map_buffer_range = hasExt("GL_ARB_map_buffer_range", numexts, exts);
    GARCH_GL_ARB_matrix_palette = hasExt("GL_ARB_matrix_palette", numexts, exts);
    GARCH_GL_ARB_multi_bind = hasExt("GL_ARB_multi_bind", numexts, exts);
    GARCH_GL_ARB_multi_draw_indirect = hasExt("GL_ARB_multi_draw_indirect", numexts, exts);
    GARCH_GL_ARB_multisample = hasExt("GL_ARB_multisample", numexts, exts);
    GARCH_GL_ARB_multitexture = hasExt("GL_ARB_multitexture", numexts, exts);
    GARCH_GL_ARB_occlusion_query = hasExt("GL_ARB_occlusion_query", numexts, exts);
    GARCH_GL_ARB_occlusion_query2 = hasExt("GL_ARB_occlusion_query2", numexts, exts);
    GARCH_GL_ARB_parallel_shader_compile = hasExt("GL_ARB_parallel_shader_compile", numexts, exts);
    GARCH_GL_ARB_pipeline_statistics_query = hasExt("GL_ARB_pipeline_statistics_query", numexts, exts);
    GARCH_GL_ARB_pixel_buffer_object = hasExt("GL_ARB_pixel_buffer_object", numexts, exts);
    GARCH_GL_ARB_point_parameters = hasExt("GL_ARB_point_parameters", numexts, exts);
    GARCH_GL_ARB_point_sprite = hasExt("GL_ARB_point_sprite", numexts, exts);
    GARCH_GL_ARB_polygon_offset_clamp = hasExt("GL_ARB_polygon_offset_clamp", numexts, exts);
    GARCH_GL_ARB_post_depth_coverage = hasExt("GL_ARB_post_depth_coverage", numexts, exts);
    GARCH_GL_ARB_program_interface_query = hasExt("GL_ARB_program_interface_query", numexts, exts);
    GARCH_GL_ARB_provoking_vertex = hasExt("GL_ARB_provoking_vertex", numexts, exts);
    GARCH_GL_ARB_query_buffer_object = hasExt("GL_ARB_query_buffer_object", numexts, exts);
    GARCH_GL_ARB_robust_buffer_access_behavior = hasExt("GL_ARB_robust_buffer_access_behavior", numexts, exts);
    GARCH_GL_ARB_robustness = hasExt("GL_ARB_robustness", numexts, exts);
    GARCH_GL_ARB_robustness_isolation = hasExt("GL_ARB_robustness_isolation", numexts, exts);
    GARCH_GL_ARB_sample_locations = hasExt("GL_ARB_sample_locations", numexts, exts);
    GARCH_GL_ARB_sample_shading = hasExt("GL_ARB_sample_shading", numexts, exts);
    GARCH_GL_ARB_sampler_objects = hasExt("GL_ARB_sampler_objects", numexts, exts);
    GARCH_GL_ARB_seamless_cube_map = hasExt("GL_ARB_seamless_cube_map", numexts, exts);
    GARCH_GL_ARB_seamless_cubemap_per_texture = hasExt("GL_ARB_seamless_cubemap_per_texture", numexts, exts);
    GARCH_GL_ARB_separate_shader_objects = hasExt("GL_ARB_separate_shader_objects", numexts, exts);
    GARCH_GL_ARB_shader_atomic_counter_ops = hasExt("GL_ARB_shader_atomic_counter_ops", numexts, exts);
    GARCH_GL_ARB_shader_atomic_counters = hasExt("GL_ARB_shader_atomic_counters", numexts, exts);
    GARCH_GL_ARB_shader_ballot = hasExt("GL_ARB_shader_ballot", numexts, exts);
    GARCH_GL_ARB_shader_bit_encoding = hasExt("GL_ARB_shader_bit_encoding", numexts, exts);
    GARCH_GL_ARB_shader_clock = hasExt("GL_ARB_shader_clock", numexts, exts);
    GARCH_GL_ARB_shader_draw_parameters = hasExt("GL_ARB_shader_draw_parameters", numexts, exts);
    GARCH_GL_ARB_shader_group_vote = hasExt("GL_ARB_shader_group_vote", numexts, exts);
    GARCH_GL_ARB_shader_image_load_store = hasExt("GL_ARB_shader_image_load_store", numexts, exts);
    GARCH_GL_ARB_shader_image_size = hasExt("GL_ARB_shader_image_size", numexts, exts);
    GARCH_GL_ARB_shader_objects = hasExt("GL_ARB_shader_objects", numexts, exts);
    GARCH_GL_ARB_shader_precision = hasExt("GL_ARB_shader_precision", numexts, exts);
    GARCH_GL_ARB_shader_stencil_export = hasExt("GL_ARB_shader_stencil_export", numexts, exts);
    GARCH_GL_ARB_shader_storage_buffer_object = hasExt("GL_ARB_shader_storage_buffer_object", numexts, exts);
    GARCH_GL_ARB_shader_subroutine = hasExt("GL_ARB_shader_subroutine", numexts, exts);
    GARCH_GL_ARB_shader_texture_image_samples = hasExt("GL_ARB_shader_texture_image_samples", numexts, exts);
    GARCH_GL_ARB_shader_texture_lod = hasExt("GL_ARB_shader_texture_lod", numexts, exts);
    GARCH_GL_ARB_shader_viewport_layer_array = hasExt("GL_ARB_shader_viewport_layer_array", numexts, exts);
    GARCH_GL_ARB_shading_language_100 = hasExt("GL_ARB_shading_language_100", numexts, exts);
    GARCH_GL_ARB_shading_language_420pack = hasExt("GL_ARB_shading_language_420pack", numexts, exts);
    GARCH_GL_ARB_shading_language_include = hasExt("GL_ARB_shading_language_include", numexts, exts);
    GARCH_GL_ARB_shading_language_packing = hasExt("GL_ARB_shading_language_packing", numexts, exts);
    GARCH_GL_ARB_shadow = hasExt("GL_ARB_shadow", numexts, exts);
    GARCH_GL_ARB_shadow_ambient = hasExt("GL_ARB_shadow_ambient", numexts, exts);
    GARCH_GL_ARB_sparse_buffer = hasExt("GL_ARB_sparse_buffer", numexts, exts);
    GARCH_GL_ARB_sparse_texture = hasExt("GL_ARB_sparse_texture", numexts, exts);
    GARCH_GL_ARB_sparse_texture2 = hasExt("GL_ARB_sparse_texture2", numexts, exts);
    GARCH_GL_ARB_sparse_texture_clamp = hasExt("GL_ARB_sparse_texture_clamp", numexts, exts);
    GARCH_GL_ARB_spirv_extensions = hasExt("GL_ARB_spirv_extensions", numexts, exts);
    GARCH_GL_ARB_stencil_texturing = hasExt("GL_ARB_stencil_texturing", numexts, exts);
    GARCH_GL_ARB_sync = hasExt("GL_ARB_sync", numexts, exts);
    GARCH_GL_ARB_tessellation_shader = hasExt("GL_ARB_tessellation_shader", numexts, exts);
    GARCH_GL_ARB_texture_barrier = hasExt("GL_ARB_texture_barrier", numexts, exts);
    GARCH_GL_ARB_texture_border_clamp = hasExt("GL_ARB_texture_border_clamp", numexts, exts);
    GARCH_GL_ARB_texture_buffer_object = hasExt("GL_ARB_texture_buffer_object", numexts, exts);
    GARCH_GL_ARB_texture_buffer_object_rgb32 = hasExt("GL_ARB_texture_buffer_object_rgb32", numexts, exts);
    GARCH_GL_ARB_texture_buffer_range = hasExt("GL_ARB_texture_buffer_range", numexts, exts);
    GARCH_GL_ARB_texture_compression = hasExt("GL_ARB_texture_compression", numexts, exts);
    GARCH_GL_ARB_texture_compression_bptc = hasExt("GL_ARB_texture_compression_bptc", numexts, exts);
    GARCH_GL_ARB_texture_compression_rgtc = hasExt("GL_ARB_texture_compression_rgtc", numexts, exts);
    GARCH_GL_ARB_texture_cube_map = hasExt("GL_ARB_texture_cube_map", numexts, exts);
    GARCH_GL_ARB_texture_cube_map_array = hasExt("GL_ARB_texture_cube_map_array", numexts, exts);
    GARCH_GL_ARB_texture_env_add = hasExt("GL_ARB_texture_env_add", numexts, exts);
    GARCH_GL_ARB_texture_env_combine = hasExt("GL_ARB_texture_env_combine", numexts, exts);
    GARCH_GL_ARB_texture_env_crossbar = hasExt("GL_ARB_texture_env_crossbar", numexts, exts);
    GARCH_GL_ARB_texture_env_dot3 = hasExt("GL_ARB_texture_env_dot3", numexts, exts);
    GARCH_GL_ARB_texture_filter_anisotropic = hasExt("GL_ARB_texture_filter_anisotropic", numexts, exts);
    GARCH_GL_ARB_texture_filter_minmax = hasExt("GL_ARB_texture_filter_minmax", numexts, exts);
    GARCH_GL_ARB_texture_float = hasExt("GL_ARB_texture_float", numexts, exts);
    GARCH_GL_ARB_texture_gather = hasExt("GL_ARB_texture_gather", numexts, exts);
    GARCH_GL_ARB_texture_mirror_clamp_to_edge = hasExt("GL_ARB_texture_mirror_clamp_to_edge", numexts, exts);
    GARCH_GL_ARB_texture_mirrored_repeat = hasExt("GL_ARB_texture_mirrored_repeat", numexts, exts);
    GARCH_GL_ARB_texture_multisample = hasExt("GL_ARB_texture_multisample", numexts, exts);
    GARCH_GL_ARB_texture_non_power_of_two = hasExt("GL_ARB_texture_non_power_of_two", numexts, exts);
    GARCH_GL_ARB_texture_query_levels = hasExt("GL_ARB_texture_query_levels", numexts, exts);
    GARCH_GL_ARB_texture_query_lod = hasExt("GL_ARB_texture_query_lod", numexts, exts);
    GARCH_GL_ARB_texture_rectangle = hasExt("GL_ARB_texture_rectangle", numexts, exts);
    GARCH_GL_ARB_texture_rg = hasExt("GL_ARB_texture_rg", numexts, exts);
    GARCH_GL_ARB_texture_rgb10_a2ui = hasExt("GL_ARB_texture_rgb10_a2ui", numexts, exts);
    GARCH_GL_ARB_texture_stencil8 = hasExt("GL_ARB_texture_stencil8", numexts, exts);
    GARCH_GL_ARB_texture_storage = hasExt("GL_ARB_texture_storage", numexts, exts);
    GARCH_GL_ARB_texture_storage_multisample = hasExt("GL_ARB_texture_storage_multisample", numexts, exts);
    GARCH_GL_ARB_texture_swizzle = hasExt("GL_ARB_texture_swizzle", numexts, exts);
    GARCH_GL_ARB_texture_view = hasExt("GL_ARB_texture_view", numexts, exts);
    GARCH_GL_ARB_timer_query = hasExt("GL_ARB_timer_query", numexts, exts);
    GARCH_GL_ARB_transform_feedback2 = hasExt("GL_ARB_transform_feedback2", numexts, exts);
    GARCH_GL_ARB_transform_feedback3 = hasExt("GL_ARB_transform_feedback3", numexts, exts);
    GARCH_GL_ARB_transform_feedback_instanced = hasExt("GL_ARB_transform_feedback_instanced", numexts, exts);
    GARCH_GL_ARB_transform_feedback_overflow_query = hasExt("GL_ARB_transform_feedback_overflow_query", numexts, exts);
    GARCH_GL_ARB_transpose_matrix = hasExt("GL_ARB_transpose_matrix", numexts, exts);
    GARCH_GL_ARB_uniform_buffer_object = hasExt("GL_ARB_uniform_buffer_object", numexts, exts);
    GARCH_GL_ARB_vertex_array_bgra = hasExt("GL_ARB_vertex_array_bgra", numexts, exts);
    GARCH_GL_ARB_vertex_array_object = hasExt("GL_ARB_vertex_array_object", numexts, exts);
    GARCH_GL_ARB_vertex_attrib_64bit = hasExt("GL_ARB_vertex_attrib_64bit", numexts, exts);
    GARCH_GL_ARB_vertex_attrib_binding = hasExt("GL_ARB_vertex_attrib_binding", numexts, exts);
    GARCH_GL_ARB_vertex_blend = hasExt("GL_ARB_vertex_blend", numexts, exts);
    GARCH_GL_ARB_vertex_buffer_object = hasExt("GL_ARB_vertex_buffer_object", numexts, exts);
    GARCH_GL_ARB_vertex_program = hasExt("GL_ARB_vertex_program", numexts, exts);
    GARCH_GL_ARB_vertex_shader = hasExt("GL_ARB_vertex_shader", numexts, exts);
    GARCH_GL_ARB_vertex_type_10f_11f_11f_rev = hasExt("GL_ARB_vertex_type_10f_11f_11f_rev", numexts, exts);
    GARCH_GL_ARB_vertex_type_2_10_10_10_rev = hasExt("GL_ARB_vertex_type_2_10_10_10_rev", numexts, exts);
    GARCH_GL_ARB_viewport_array = hasExt("GL_ARB_viewport_array", numexts, exts);
    GARCH_GL_ARB_window_pos = hasExt("GL_ARB_window_pos", numexts, exts);
    GARCH_GL_EXT_422_pixels = hasExt("GL_EXT_422_pixels", numexts, exts);
    GARCH_GL_EXT_EGL_image_storage = hasExt("GL_EXT_EGL_image_storage", numexts, exts);
    GARCH_GL_EXT_EGL_sync = hasExt("GL_EXT_EGL_sync", numexts, exts);
    GARCH_GL_EXT_abgr = hasExt("GL_EXT_abgr", numexts, exts);
    GARCH_GL_EXT_bgra = hasExt("GL_EXT_bgra", numexts, exts);
    GARCH_GL_EXT_bindable_uniform = hasExt("GL_EXT_bindable_uniform", numexts, exts);
    GARCH_GL_EXT_blend_color = hasExt("GL_EXT_blend_color", numexts, exts);
    GARCH_GL_EXT_blend_equation_separate = hasExt("GL_EXT_blend_equation_separate", numexts, exts);
    GARCH_GL_EXT_blend_func_separate = hasExt("GL_EXT_blend_func_separate", numexts, exts);
    GARCH_GL_EXT_blend_logic_op = hasExt("GL_EXT_blend_logic_op", numexts, exts);
    GARCH_GL_EXT_blend_minmax = hasExt("GL_EXT_blend_minmax", numexts, exts);
    GARCH_GL_EXT_blend_subtract = hasExt("GL_EXT_blend_subtract", numexts, exts);
    GARCH_GL_EXT_clip_volume_hint = hasExt("GL_EXT_clip_volume_hint", numexts, exts);
    GARCH_GL_EXT_cmyka = hasExt("GL_EXT_cmyka", numexts, exts);
    GARCH_GL_EXT_color_subtable = hasExt("GL_EXT_color_subtable", numexts, exts);
    GARCH_GL_EXT_compiled_vertex_array = hasExt("GL_EXT_compiled_vertex_array", numexts, exts);
    GARCH_GL_EXT_convolution = hasExt("GL_EXT_convolution", numexts, exts);
    GARCH_GL_EXT_coordinate_frame = hasExt("GL_EXT_coordinate_frame", numexts, exts);
    GARCH_GL_EXT_copy_texture = hasExt("GL_EXT_copy_texture", numexts, exts);
    GARCH_GL_EXT_cull_vertex = hasExt("GL_EXT_cull_vertex", numexts, exts);
    GARCH_GL_EXT_debug_label = hasExt("GL_EXT_debug_label", numexts, exts);
    GARCH_GL_EXT_debug_marker = hasExt("GL_EXT_debug_marker", numexts, exts);
    GARCH_GL_EXT_depth_bounds_test = hasExt("GL_EXT_depth_bounds_test", numexts, exts);
    GARCH_GL_EXT_direct_state_access = hasExt("GL_EXT_direct_state_access", numexts, exts);
    GARCH_GL_EXT_draw_buffers2 = hasExt("GL_EXT_draw_buffers2", numexts, exts);
    GARCH_GL_EXT_draw_instanced = hasExt("GL_EXT_draw_instanced", numexts, exts);
    GARCH_GL_EXT_draw_range_elements = hasExt("GL_EXT_draw_range_elements", numexts, exts);
    GARCH_GL_EXT_external_buffer = hasExt("GL_EXT_external_buffer", numexts, exts);
    GARCH_GL_EXT_fog_coord = hasExt("GL_EXT_fog_coord", numexts, exts);
    GARCH_GL_EXT_framebuffer_blit = hasExt("GL_EXT_framebuffer_blit", numexts, exts);
    GARCH_GL_EXT_framebuffer_multisample = hasExt("GL_EXT_framebuffer_multisample", numexts, exts);
    GARCH_GL_EXT_framebuffer_multisample_blit_scaled = hasExt("GL_EXT_framebuffer_multisample_blit_scaled", numexts, exts);
    GARCH_GL_EXT_framebuffer_object = hasExt("GL_EXT_framebuffer_object", numexts, exts);
    GARCH_GL_EXT_framebuffer_sRGB = hasExt("GL_EXT_framebuffer_sRGB", numexts, exts);
    GARCH_GL_EXT_geometry_shader4 = hasExt("GL_EXT_geometry_shader4", numexts, exts);
    GARCH_GL_EXT_gpu_program_parameters = hasExt("GL_EXT_gpu_program_parameters", numexts, exts);
    GARCH_GL_EXT_gpu_shader4 = hasExt("GL_EXT_gpu_shader4", numexts, exts);
    GARCH_GL_EXT_histogram = hasExt("GL_EXT_histogram", numexts, exts);
    GARCH_GL_EXT_index_array_formats = hasExt("GL_EXT_index_array_formats", numexts, exts);
    GARCH_GL_EXT_index_func = hasExt("GL_EXT_index_func", numexts, exts);
    GARCH_GL_EXT_index_material = hasExt("GL_EXT_index_material", numexts, exts);
    GARCH_GL_EXT_index_texture = hasExt("GL_EXT_index_texture", numexts, exts);
    GARCH_GL_EXT_light_texture = hasExt("GL_EXT_light_texture", numexts, exts);
    GARCH_GL_EXT_memory_object = hasExt("GL_EXT_memory_object", numexts, exts);
    GARCH_GL_EXT_memory_object_fd = hasExt("GL_EXT_memory_object_fd", numexts, exts);
    GARCH_GL_EXT_memory_object_win32 = hasExt("GL_EXT_memory_object_win32", numexts, exts);
    GARCH_GL_EXT_misc_attribute = hasExt("GL_EXT_misc_attribute", numexts, exts);
    GARCH_GL_EXT_multi_draw_arrays = hasExt("GL_EXT_multi_draw_arrays", numexts, exts);
    GARCH_GL_EXT_multisample = hasExt("GL_EXT_multisample", numexts, exts);
    GARCH_GL_EXT_multiview_tessellation_geometry_shader = hasExt("GL_EXT_multiview_tessellation_geometry_shader", numexts, exts);
    GARCH_GL_EXT_multiview_texture_multisample = hasExt("GL_EXT_multiview_texture_multisample", numexts, exts);
    GARCH_GL_EXT_multiview_timer_query = hasExt("GL_EXT_multiview_timer_query", numexts, exts);
    GARCH_GL_EXT_packed_depth_stencil = hasExt("GL_EXT_packed_depth_stencil", numexts, exts);
    GARCH_GL_EXT_packed_float = hasExt("GL_EXT_packed_float", numexts, exts);
    GARCH_GL_EXT_packed_pixels = hasExt("GL_EXT_packed_pixels", numexts, exts);
    GARCH_GL_EXT_paletted_texture = hasExt("GL_EXT_paletted_texture", numexts, exts);
    GARCH_GL_EXT_pixel_buffer_object = hasExt("GL_EXT_pixel_buffer_object", numexts, exts);
    GARCH_GL_EXT_pixel_transform = hasExt("GL_EXT_pixel_transform", numexts, exts);
    GARCH_GL_EXT_pixel_transform_color_table = hasExt("GL_EXT_pixel_transform_color_table", numexts, exts);
    GARCH_GL_EXT_point_parameters = hasExt("GL_EXT_point_parameters", numexts, exts);
    GARCH_GL_EXT_polygon_offset = hasExt("GL_EXT_polygon_offset", numexts, exts);
    GARCH_GL_EXT_polygon_offset_clamp = hasExt("GL_EXT_polygon_offset_clamp", numexts, exts);
    GARCH_GL_EXT_post_depth_coverage = hasExt("GL_EXT_post_depth_coverage", numexts, exts);
    GARCH_GL_EXT_provoking_vertex = hasExt("GL_EXT_provoking_vertex", numexts, exts);
    GARCH_GL_EXT_raster_multisample = hasExt("GL_EXT_raster_multisample", numexts, exts);
    GARCH_GL_EXT_rescale_normal = hasExt("GL_EXT_rescale_normal", numexts, exts);
    GARCH_GL_EXT_semaphore = hasExt("GL_EXT_semaphore", numexts, exts);
    GARCH_GL_EXT_semaphore_fd = hasExt("GL_EXT_semaphore_fd", numexts, exts);
    GARCH_GL_EXT_semaphore_win32 = hasExt("GL_EXT_semaphore_win32", numexts, exts);
    GARCH_GL_EXT_secondary_color = hasExt("GL_EXT_secondary_color", numexts, exts);
    GARCH_GL_EXT_separate_shader_objects = hasExt("GL_EXT_separate_shader_objects", numexts, exts);
    GARCH_GL_EXT_separate_specular_color = hasExt("GL_EXT_separate_specular_color", numexts, exts);
    GARCH_GL_EXT_shader_framebuffer_fetch = hasExt("GL_EXT_shader_framebuffer_fetch", numexts, exts);
    GARCH_GL_EXT_shader_framebuffer_fetch_non_coherent = hasExt("GL_EXT_shader_framebuffer_fetch_non_coherent", numexts, exts);
    GARCH_GL_EXT_shader_image_load_formatted = hasExt("GL_EXT_shader_image_load_formatted", numexts, exts);
    GARCH_GL_EXT_shader_image_load_store = hasExt("GL_EXT_shader_image_load_store", numexts, exts);
    GARCH_GL_EXT_shader_integer_mix = hasExt("GL_EXT_shader_integer_mix", numexts, exts);
    GARCH_GL_EXT_shadow_funcs = hasExt("GL_EXT_shadow_funcs", numexts, exts);
    GARCH_GL_EXT_shared_texture_palette = hasExt("GL_EXT_shared_texture_palette", numexts, exts);
    GARCH_GL_EXT_sparse_texture2 = hasExt("GL_EXT_sparse_texture2", numexts, exts);
    GARCH_GL_EXT_stencil_clear_tag = hasExt("GL_EXT_stencil_clear_tag", numexts, exts);
    GARCH_GL_EXT_stencil_two_side = hasExt("GL_EXT_stencil_two_side", numexts, exts);
    GARCH_GL_EXT_stencil_wrap = hasExt("GL_EXT_stencil_wrap", numexts, exts);
    GARCH_GL_EXT_subtexture = hasExt("GL_EXT_subtexture", numexts, exts);
    GARCH_GL_EXT_texture = hasExt("GL_EXT_texture", numexts, exts);
    GARCH_GL_EXT_texture3D = hasExt("GL_EXT_texture3D", numexts, exts);
    GARCH_GL_EXT_texture_array = hasExt("GL_EXT_texture_array", numexts, exts);
    GARCH_GL_EXT_texture_buffer_object = hasExt("GL_EXT_texture_buffer_object", numexts, exts);
    GARCH_GL_EXT_texture_compression_latc = hasExt("GL_EXT_texture_compression_latc", numexts, exts);
    GARCH_GL_EXT_texture_compression_rgtc = hasExt("GL_EXT_texture_compression_rgtc", numexts, exts);
    GARCH_GL_EXT_texture_compression_s3tc = hasExt("GL_EXT_texture_compression_s3tc", numexts, exts);
    GARCH_GL_EXT_texture_cube_map = hasExt("GL_EXT_texture_cube_map", numexts, exts);
    GARCH_GL_EXT_texture_env_add = hasExt("GL_EXT_texture_env_add", numexts, exts);
    GARCH_GL_EXT_texture_env_combine = hasExt("GL_EXT_texture_env_combine", numexts, exts);
    GARCH_GL_EXT_texture_env_dot3 = hasExt("GL_EXT_texture_env_dot3", numexts, exts);
    GARCH_GL_EXT_texture_filter_anisotropic = hasExt("GL_EXT_texture_filter_anisotropic", numexts, exts);
    GARCH_GL_EXT_texture_filter_minmax = hasExt("GL_EXT_texture_filter_minmax", numexts, exts);
    GARCH_GL_EXT_texture_integer = hasExt("GL_EXT_texture_integer", numexts, exts);
    GARCH_GL_EXT_texture_lod_bias = hasExt("GL_EXT_texture_lod_bias", numexts, exts);
    GARCH_GL_EXT_texture_mirror_clamp = hasExt("GL_EXT_texture_mirror_clamp", numexts, exts);
    GARCH_GL_EXT_texture_object = hasExt("GL_EXT_texture_object", numexts, exts);
    GARCH_GL_EXT_texture_perturb_normal = hasExt("GL_EXT_texture_perturb_normal", numexts, exts);
    GARCH_GL_EXT_texture_sRGB = hasExt("GL_EXT_texture_sRGB", numexts, exts);
    GARCH_GL_EXT_texture_sRGB_R8 = hasExt("GL_EXT_texture_sRGB_R8", numexts, exts);
    GARCH_GL_EXT_texture_sRGB_decode = hasExt("GL_EXT_texture_sRGB_decode", numexts, exts);
    GARCH_GL_EXT_texture_shared_exponent = hasExt("GL_EXT_texture_shared_exponent", numexts, exts);
    GARCH_GL_EXT_texture_snorm = hasExt("GL_EXT_texture_snorm", numexts, exts);
    GARCH_GL_EXT_texture_swizzle = hasExt("GL_EXT_texture_swizzle", numexts, exts);
    GARCH_GL_NV_timeline_semaphore = hasExt("GL_NV_timeline_semaphore", numexts, exts);
    GARCH_GL_EXT_timer_query = hasExt("GL_EXT_timer_query", numexts, exts);
    GARCH_GL_EXT_transform_feedback = hasExt("GL_EXT_transform_feedback", numexts, exts);
    GARCH_GL_EXT_vertex_array = hasExt("GL_EXT_vertex_array", numexts, exts);
    GARCH_GL_EXT_vertex_array_bgra = hasExt("GL_EXT_vertex_array_bgra", numexts, exts);
    GARCH_GL_EXT_vertex_attrib_64bit = hasExt("GL_EXT_vertex_attrib_64bit", numexts, exts);
    GARCH_GL_EXT_vertex_shader = hasExt("GL_EXT_vertex_shader", numexts, exts);
    GARCH_GL_EXT_vertex_weighting = hasExt("GL_EXT_vertex_weighting", numexts, exts);
    GARCH_GL_EXT_win32_keyed_mutex = hasExt("GL_EXT_win32_keyed_mutex", numexts, exts);
    GARCH_GL_EXT_window_rectangles = hasExt("GL_EXT_window_rectangles", numexts, exts);
    GARCH_GL_EXT_x11_sync_object = hasExt("GL_EXT_x11_sync_object", numexts, exts);
    GARCH_GL_INTEL_conservative_rasterization = hasExt("GL_INTEL_conservative_rasterization", numexts, exts);
    GARCH_GL_INTEL_fragment_shader_ordering = hasExt("GL_INTEL_fragment_shader_ordering", numexts, exts);
    GARCH_GL_INTEL_framebuffer_CMAA = hasExt("GL_INTEL_framebuffer_CMAA", numexts, exts);
    GARCH_GL_INTEL_map_texture = hasExt("GL_INTEL_map_texture", numexts, exts);
    GARCH_GL_INTEL_blackhole_render = hasExt("GL_INTEL_blackhole_render", numexts, exts);
    GARCH_GL_INTEL_parallel_arrays = hasExt("GL_INTEL_parallel_arrays", numexts, exts);
    GARCH_GL_INTEL_performance_query = hasExt("GL_INTEL_performance_query", numexts, exts);
    GARCH_GL_KHR_blend_equation_advanced = hasExt("GL_KHR_blend_equation_advanced", numexts, exts);
    GARCH_GL_KHR_blend_equation_advanced_coherent = hasExt("GL_KHR_blend_equation_advanced_coherent", numexts, exts);
    GARCH_GL_KHR_context_flush_control = hasExt("GL_KHR_context_flush_control", numexts, exts);
    GARCH_GL_KHR_debug = hasExt("GL_KHR_debug", numexts, exts);
    GARCH_GL_KHR_no_error = hasExt("GL_KHR_no_error", numexts, exts);
    GARCH_GL_KHR_robust_buffer_access_behavior = hasExt("GL_KHR_robust_buffer_access_behavior", numexts, exts);
    GARCH_GL_KHR_robustness = hasExt("GL_KHR_robustness", numexts, exts);
    GARCH_GL_KHR_shader_subgroup = hasExt("GL_KHR_shader_subgroup", numexts, exts);
    GARCH_GL_KHR_texture_compression_astc_hdr = hasExt("GL_KHR_texture_compression_astc_hdr", numexts, exts);
    GARCH_GL_KHR_texture_compression_astc_ldr = hasExt("GL_KHR_texture_compression_astc_ldr", numexts, exts);
    GARCH_GL_KHR_texture_compression_astc_sliced_3d = hasExt("GL_KHR_texture_compression_astc_sliced_3d", numexts, exts);
    GARCH_GL_KHR_parallel_shader_compile = hasExt("GL_KHR_parallel_shader_compile", numexts, exts);
    GARCH_GL_NVX_blend_equation_advanced_multi_draw_buffers = hasExt("GL_NVX_blend_equation_advanced_multi_draw_buffers", numexts, exts);
    GARCH_GL_NVX_conditional_render = hasExt("GL_NVX_conditional_render", numexts, exts);
    GARCH_GL_NVX_gpu_memory_info = hasExt("GL_NVX_gpu_memory_info", numexts, exts);
    GARCH_GL_NVX_linked_gpu_multicast = hasExt("GL_NVX_linked_gpu_multicast", numexts, exts);
    GARCH_GL_NV_alpha_to_coverage_dither_control = hasExt("GL_NV_alpha_to_coverage_dither_control", numexts, exts);
    GARCH_GL_NV_bindless_multi_draw_indirect = hasExt("GL_NV_bindless_multi_draw_indirect", numexts, exts);
    GARCH_GL_NV_bindless_multi_draw_indirect_count = hasExt("GL_NV_bindless_multi_draw_indirect_count", numexts, exts);
    GARCH_GL_NV_bindless_texture = hasExt("GL_NV_bindless_texture", numexts, exts);
    GARCH_GL_NV_blend_equation_advanced = hasExt("GL_NV_blend_equation_advanced", numexts, exts);
    GARCH_GL_NV_blend_equation_advanced_coherent = hasExt("GL_NV_blend_equation_advanced_coherent", numexts, exts);
    GARCH_GL_NV_blend_minmax_factor = hasExt("GL_NV_blend_minmax_factor", numexts, exts);
    GARCH_GL_NV_blend_square = hasExt("GL_NV_blend_square", numexts, exts);
    GARCH_GL_NV_clip_space_w_scaling = hasExt("GL_NV_clip_space_w_scaling", numexts, exts);
    GARCH_GL_NV_command_list = hasExt("GL_NV_command_list", numexts, exts);
    GARCH_GL_NV_compute_program5 = hasExt("GL_NV_compute_program5", numexts, exts);
    GARCH_GL_NV_compute_shader_derivatives = hasExt("GL_NV_compute_shader_derivatives", numexts, exts);
    GARCH_GL_NV_conditional_render = hasExt("GL_NV_conditional_render", numexts, exts);
    GARCH_GL_NV_conservative_raster = hasExt("GL_NV_conservative_raster", numexts, exts);
    GARCH_GL_NV_conservative_raster_dilate = hasExt("GL_NV_conservative_raster_dilate", numexts, exts);
    GARCH_GL_NV_conservative_raster_pre_snap = hasExt("GL_NV_conservative_raster_pre_snap", numexts, exts);
    GARCH_GL_NV_conservative_raster_pre_snap_triangles = hasExt("GL_NV_conservative_raster_pre_snap_triangles", numexts, exts);
    GARCH_GL_NV_conservative_raster_underestimation = hasExt("GL_NV_conservative_raster_underestimation", numexts, exts);
    GARCH_GL_NV_copy_depth_to_color = hasExt("GL_NV_copy_depth_to_color", numexts, exts);
    GARCH_GL_NV_copy_image = hasExt("GL_NV_copy_image", numexts, exts);
    GARCH_GL_NV_deep_texture3D = hasExt("GL_NV_deep_texture3D", numexts, exts);
    GARCH_GL_NV_depth_buffer_float = hasExt("GL_NV_depth_buffer_float", numexts, exts);
    GARCH_GL_NV_depth_clamp = hasExt("GL_NV_depth_clamp", numexts, exts);
    GARCH_GL_NV_draw_texture = hasExt("GL_NV_draw_texture", numexts, exts);
    GARCH_GL_NV_draw_vulkan_image = hasExt("GL_NV_draw_vulkan_image", numexts, exts);
    GARCH_GL_NV_evaluators = hasExt("GL_NV_evaluators", numexts, exts);
    GARCH_GL_NV_explicit_multisample = hasExt("GL_NV_explicit_multisample", numexts, exts);
    GARCH_GL_NV_fence = hasExt("GL_NV_fence", numexts, exts);
    GARCH_GL_NV_fill_rectangle = hasExt("GL_NV_fill_rectangle", numexts, exts);
    GARCH_GL_NV_float_buffer = hasExt("GL_NV_float_buffer", numexts, exts);
    GARCH_GL_NV_fog_distance = hasExt("GL_NV_fog_distance", numexts, exts);
    GARCH_GL_NV_fragment_coverage_to_color = hasExt("GL_NV_fragment_coverage_to_color", numexts, exts);
    GARCH_GL_NV_fragment_program = hasExt("GL_NV_fragment_program", numexts, exts);
    GARCH_GL_NV_fragment_program2 = hasExt("GL_NV_fragment_program2", numexts, exts);
    GARCH_GL_NV_fragment_program4 = hasExt("GL_NV_fragment_program4", numexts, exts);
    GARCH_GL_NV_fragment_program_option = hasExt("GL_NV_fragment_program_option", numexts, exts);
    GARCH_GL_NV_fragment_shader_barycentric = hasExt("GL_NV_fragment_shader_barycentric", numexts, exts);
    GARCH_GL_NV_fragment_shader_interlock = hasExt("GL_NV_fragment_shader_interlock", numexts, exts);
    GARCH_GL_NV_framebuffer_mixed_samples = hasExt("GL_NV_framebuffer_mixed_samples", numexts, exts);
    GARCH_GL_NV_framebuffer_multisample_coverage = hasExt("GL_NV_framebuffer_multisample_coverage", numexts, exts);
    GARCH_GL_NV_geometry_program4 = hasExt("GL_NV_geometry_program4", numexts, exts);
    GARCH_GL_NV_geometry_shader4 = hasExt("GL_NV_geometry_shader4", numexts, exts);
    GARCH_GL_NV_geometry_shader_passthrough = hasExt("GL_NV_geometry_shader_passthrough", numexts, exts);
    GARCH_GL_NV_gpu_program4 = hasExt("GL_NV_gpu_program4", numexts, exts);
    GARCH_GL_NV_gpu_program5 = hasExt("GL_NV_gpu_program5", numexts, exts);
    GARCH_GL_NV_gpu_program5_mem_extended = hasExt("GL_NV_gpu_program5_mem_extended", numexts, exts);
    GARCH_GL_NV_gpu_shader5 = hasExt("GL_NV_gpu_shader5", numexts, exts);
    GARCH_GL_NV_half_float = hasExt("GL_NV_half_float", numexts, exts);
    GARCH_GL_NV_internalformat_sample_query = hasExt("GL_NV_internalformat_sample_query", numexts, exts);
    GARCH_GL_NV_light_max_exponent = hasExt("GL_NV_light_max_exponent", numexts, exts);
    GARCH_GL_NV_gpu_multicast = hasExt("GL_NV_gpu_multicast", numexts, exts);
    GARCH_GL_NVX_gpu_multicast2 = hasExt("GL_NVX_gpu_multicast2", numexts, exts);
    GARCH_GL_NVX_progress_fence = hasExt("GL_NVX_progress_fence", numexts, exts);
    GARCH_GL_NV_memory_attachment = hasExt("GL_NV_memory_attachment", numexts, exts);
    GARCH_GL_NV_memory_object_sparse = hasExt("GL_NV_memory_object_sparse", numexts, exts);
    GARCH_GL_NV_mesh_shader = hasExt("GL_NV_mesh_shader", numexts, exts);
    GARCH_GL_NV_multisample_coverage = hasExt("GL_NV_multisample_coverage", numexts, exts);
    GARCH_GL_NV_multisample_filter_hint = hasExt("GL_NV_multisample_filter_hint", numexts, exts);
    GARCH_GL_NV_occlusion_query = hasExt("GL_NV_occlusion_query", numexts, exts);
    GARCH_GL_NV_packed_depth_stencil = hasExt("GL_NV_packed_depth_stencil", numexts, exts);
    GARCH_GL_NV_parameter_buffer_object = hasExt("GL_NV_parameter_buffer_object", numexts, exts);
    GARCH_GL_NV_parameter_buffer_object2 = hasExt("GL_NV_parameter_buffer_object2", numexts, exts);
    GARCH_GL_NV_path_rendering = hasExt("GL_NV_path_rendering", numexts, exts);
    GARCH_GL_NV_path_rendering_shared_edge = hasExt("GL_NV_path_rendering_shared_edge", numexts, exts);
    GARCH_GL_NV_pixel_data_range = hasExt("GL_NV_pixel_data_range", numexts, exts);
    GARCH_GL_NV_point_sprite = hasExt("GL_NV_point_sprite", numexts, exts);
    GARCH_GL_NV_present_video = hasExt("GL_NV_present_video", numexts, exts);
    GARCH_GL_NV_primitive_restart = hasExt("GL_NV_primitive_restart", numexts, exts);
    GARCH_GL_NV_query_resource = hasExt("GL_NV_query_resource", numexts, exts);
    GARCH_GL_NV_query_resource_tag = hasExt("GL_NV_query_resource_tag", numexts, exts);
    GARCH_GL_NV_register_combiners = hasExt("GL_NV_register_combiners", numexts, exts);
    GARCH_GL_NV_register_combiners2 = hasExt("GL_NV_register_combiners2", numexts, exts);
    GARCH_GL_NV_representative_fragment_test = hasExt("GL_NV_representative_fragment_test", numexts, exts);
    GARCH_GL_NV_robustness_video_memory_purge = hasExt("GL_NV_robustness_video_memory_purge", numexts, exts);
    GARCH_GL_NV_sample_locations = hasExt("GL_NV_sample_locations", numexts, exts);
    GARCH_GL_NV_sample_mask_override_coverage = hasExt("GL_NV_sample_mask_override_coverage", numexts, exts);
    GARCH_GL_NV_scissor_exclusive = hasExt("GL_NV_scissor_exclusive", numexts, exts);
    GARCH_GL_NV_shader_atomic_counters = hasExt("GL_NV_shader_atomic_counters", numexts, exts);
    GARCH_GL_NV_shader_atomic_float = hasExt("GL_NV_shader_atomic_float", numexts, exts);
    GARCH_GL_NV_shader_atomic_float64 = hasExt("GL_NV_shader_atomic_float64", numexts, exts);
    GARCH_GL_NV_shader_atomic_fp16_vector = hasExt("GL_NV_shader_atomic_fp16_vector", numexts, exts);
    GARCH_GL_NV_shader_atomic_int64 = hasExt("GL_NV_shader_atomic_int64", numexts, exts);
    GARCH_GL_NV_shader_buffer_load = hasExt("GL_NV_shader_buffer_load", numexts, exts);
    GARCH_GL_NV_shader_buffer_store = hasExt("GL_NV_shader_buffer_store", numexts, exts);
    GARCH_GL_NV_shader_storage_buffer_object = hasExt("GL_NV_shader_storage_buffer_object", numexts, exts);
    GARCH_GL_NV_shader_subgroup_partitioned = hasExt("GL_NV_shader_subgroup_partitioned", numexts, exts);
    GARCH_GL_NV_shader_texture_footprint = hasExt("GL_NV_shader_texture_footprint", numexts, exts);
    GARCH_GL_NV_shader_thread_group = hasExt("GL_NV_shader_thread_group", numexts, exts);
    GARCH_GL_NV_shader_thread_shuffle = hasExt("GL_NV_shader_thread_shuffle", numexts, exts);
    GARCH_GL_NV_shading_rate_image = hasExt("GL_NV_shading_rate_image", numexts, exts);
    GARCH_GL_NV_stereo_view_rendering = hasExt("GL_NV_stereo_view_rendering", numexts, exts);
    GARCH_GL_NV_tessellation_program5 = hasExt("GL_NV_tessellation_program5", numexts, exts);
    GARCH_GL_NV_texgen_emboss = hasExt("GL_NV_texgen_emboss", numexts, exts);
    GARCH_GL_NV_texgen_reflection = hasExt("GL_NV_texgen_reflection", numexts, exts);
    GARCH_GL_NV_texture_barrier = hasExt("GL_NV_texture_barrier", numexts, exts);
    GARCH_GL_NV_texture_compression_vtc = hasExt("GL_NV_texture_compression_vtc", numexts, exts);
    GARCH_GL_NV_texture_env_combine4 = hasExt("GL_NV_texture_env_combine4", numexts, exts);
    GARCH_GL_NV_texture_expand_normal = hasExt("GL_NV_texture_expand_normal", numexts, exts);
    GARCH_GL_NV_texture_multisample = hasExt("GL_NV_texture_multisample", numexts, exts);
    GARCH_GL_NV_texture_rectangle = hasExt("GL_NV_texture_rectangle", numexts, exts);
    GARCH_GL_NV_texture_rectangle_compressed = hasExt("GL_NV_texture_rectangle_compressed", numexts, exts);
    GARCH_GL_NV_texture_shader = hasExt("GL_NV_texture_shader", numexts, exts);
    GARCH_GL_NV_texture_shader2 = hasExt("GL_NV_texture_shader2", numexts, exts);
    GARCH_GL_NV_texture_shader3 = hasExt("GL_NV_texture_shader3", numexts, exts);
    GARCH_GL_NV_transform_feedback = hasExt("GL_NV_transform_feedback", numexts, exts);
    GARCH_GL_NV_transform_feedback2 = hasExt("GL_NV_transform_feedback2", numexts, exts);
    GARCH_GL_NV_uniform_buffer_unified_memory = hasExt("GL_NV_uniform_buffer_unified_memory", numexts, exts);
    GARCH_GL_NV_vdpau_interop = hasExt("GL_NV_vdpau_interop", numexts, exts);
    GARCH_GL_NV_vdpau_interop2 = hasExt("GL_NV_vdpau_interop2", numexts, exts);
    GARCH_GL_NV_vertex_array_range = hasExt("GL_NV_vertex_array_range", numexts, exts);
    GARCH_GL_NV_vertex_array_range2 = hasExt("GL_NV_vertex_array_range2", numexts, exts);
    GARCH_GL_NV_vertex_attrib_integer_64bit = hasExt("GL_NV_vertex_attrib_integer_64bit", numexts, exts);
    GARCH_GL_NV_vertex_buffer_unified_memory = hasExt("GL_NV_vertex_buffer_unified_memory", numexts, exts);
    GARCH_GL_NV_vertex_program = hasExt("GL_NV_vertex_program", numexts, exts);
    GARCH_GL_NV_vertex_program1_1 = hasExt("GL_NV_vertex_program1_1", numexts, exts);
    GARCH_GL_NV_vertex_program2 = hasExt("GL_NV_vertex_program2", numexts, exts);
    GARCH_GL_NV_vertex_program2_option = hasExt("GL_NV_vertex_program2_option", numexts, exts);
    GARCH_GL_NV_vertex_program3 = hasExt("GL_NV_vertex_program3", numexts, exts);
    GARCH_GL_NV_vertex_program4 = hasExt("GL_NV_vertex_program4", numexts, exts);
    GARCH_GL_NV_video_capture = hasExt("GL_NV_video_capture", numexts, exts);
    GARCH_GL_NV_viewport_array2 = hasExt("GL_NV_viewport_array2", numexts, exts);
    GARCH_GL_NV_viewport_swizzle = hasExt("GL_NV_viewport_swizzle", numexts, exts);
    GARCH_GL_EXT_texture_shadow_lod = hasExt("GL_EXT_texture_shadow_lod", numexts, exts);
