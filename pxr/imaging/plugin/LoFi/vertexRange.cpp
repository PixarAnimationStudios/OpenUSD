...
#include "pxr/imaging/plugin/LoFi/vertexRange.h"

PXR_NAMESPACE_OPEN_SCOPE

// constructor
LoFiVertexRange::LoFiVertexRange(LoFiVertexRangeChannel channel,
...
// destructor
LoFiVertexRange::~LoFiVertexRange()
{
}

size_t LoFiVertexRange::ComputeDatasHash(const char* datas)
{
  size_t hash = 0;
...
size_t LoFiVertexRange::ComputeRegistryKey()
{
  size_t key = 0;
...
// allocate
void LoFiVertexRange::Reallocate()
{
...
void LoFiVertexRange::Populate(const void* datas)
{
  glBindBuffer(GL_ARRAY_BUFFER, _vbo);
  glBufferSubData(
    GL_ARRAY_BUFFER, 
...
void LoFiVertexRange::ComputeOutputDatas(const GfVec3i* samples,
                                          char* result)
{
