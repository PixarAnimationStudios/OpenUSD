//
// Copyright 2016 benmalartre
//
// Unlicensed 
//
#include "pxr/imaging/plugin/LoFi/sceneDelegate.h"
...
LoFiTestDelegate::LoFiTestDelegate(HdRenderIndex *parentIndex,
...
void
LoFiTestDelegate::SetRefineLevel(int level)
{
    _refineLevel = level;
...
void
LoFiTestDelegate::SetVisibility(bool vis)
{
    _visibility = vis;
    TF_FOR_ALL(it, _meshes) {
        GetRenderIndex().GetChangeTracker().MarkRprimDirty(
...
void
LoFiTestDelegate::AddMesh(SdfPath const &id)
{
...
void
LoFiTestDelegate::AddBasisCurves(SdfPath const &id,
                                    VtVec3fArray const &points,
...
void
LoFiTestDelegate::AddPoints(SdfPath const &id,
                               VtVec3fArray const &points,
                               VtValue const &color,
                               HdInterpolation colorInterpolation,
                               VtValue const &opacity,
...
void
LoFiTestDelegate::AddInstancer(SdfPath const &id,
...
void
LoFiTestDelegate::SetInstancerProperties(SdfPath const &id,
...
void
LoFiTestDelegate::AddPrimvar(SdfPath const& id,
                               TfToken const& name,
                               VtValue const& value,
...
void
LoFiTestDelegate::UpdatePrimvarValue(SdfPath const& id,
                                       TfToken const& name,
                                       VtValue const& value)
{
    _Primvars::iterator pvIt;
...
void
LoFiTestDelegate::RemovePrimvar(SdfPath const& id, TfToken const& name)
{
    _Primvars::iterator pvIt;
    if (_FindPrimvar(id, name, &pvIt)) {
...
void 
LoFiTestDelegate::AddMaterialResource(SdfPath const &id,
...
void 
LoFiTestDelegate::UpdateMaterialResource(SdfPath const &materialId, 
                                            VtValue materialResource)
{
...
void 
LoFiTestDelegate::BindMaterial(SdfPath const &rprimId, 
...
void 
LoFiTestDelegate::RebindMaterial(SdfPath const &rprimId, 
                                    SdfPath const &materialId)
{
...
void
LoFiTestDelegate::HideRprim(SdfPath const& id) 
{
...
void
LoFiTestDelegate::UnhideRprim(SdfPath const& id) 
{
...
void
LoFiTestDelegate::SetReprSelector(SdfPath const &id,
...
void
LoFiTestDelegate::SetRefineLevel(SdfPath const &id, int refineLevel)
{
...
void
LoFiTestDelegate::SetVisibility(SdfPath const &id, bool vis)
{
...
void
LoFiTestDelegate::UpdatePositions(SdfPath const &id, float time)
{
   if (_meshes.find(id) != _meshes.end()) {
...
void
LoFiTestDelegate::UpdateRprims(float time)
{
    // update prims
    float delta = 0.01f;
    HdChangeTracker& tracker = GetRenderIndex().GetChangeTracker();
...
void
LoFiTestDelegate::UpdateInstancerPrimvars(float time)
{
    // update instancers
...
void
LoFiTestDelegate::UpdateInstancerPrototypes(float time)
{
...
void
LoFiTestDelegate::AddRenderBuffer(SdfPath const &id,
...
void
LoFiTestDelegate::AddCamera(SdfPath const &id)
{
    HdRenderIndex& index = GetRenderIndex();
...
void
LoFiTestDelegate::UpdateCamera(SdfPath const &id,
                                  TfToken const &key,
                                  VtValue value)
{
...
void
LoFiTestDelegate::UpdateTask(SdfPath const &id,
                                TfToken const &key,
                                VtValue value)
{
...
/*virtual*/
TfToken
LoFiTestDelegate::GetRenderTag(SdfPath const& id)
{
    HD_TRACE_FUNCTION();
...
/*virtual*/
HdMeshTopology 
LoFiTestDelegate::GetMeshTopology(SdfPath const& id)
{
    HD_TRACE_FUNCTION();
...
LoFiTestDelegate::GetBasisCurvesTopology(SdfPath const& id)
{
    HD_TRACE_FUNCTION();
...
/*virtual*/
PxOsdSubdivTags
LoFiTestDelegate::GetSubdivTags(SdfPath const& id)
{
    HD_TRACE_FUNCTION();
...
/*virtual*/
GfRange3d
LoFiTestDelegate::GetExtent(SdfPath const& id)
{
    HD_TRACE_FUNCTION();
...
/*virtual*/
bool
LoFiTestDelegate::GetDoubleSided(SdfPath const& id)
{
    if (_meshes.find(id) != _meshes.end()) {
...
/*virtual*/
HdDisplayStyle 
LoFiTestDelegate::GetDisplayStyle(SdfPath const& id)
{
...
/*virtual*/
VtIntArray
LoFiTestDelegate::GetInstanceIndices(SdfPath const& instancerId,
...
/*virtual*/
GfMatrix4d
LoFiTestDelegate::GetInstancerTransform(SdfPath const& instancerId)
{
    HD_TRACE_FUNCTION();
    if (_Instancer *instancer = TfMapLookupPtr(_instancers, instancerId)) {
...
/*virtual*/
SdfPath 
LoFiTestDelegate::GetMaterialId(SdfPath const& rprimId)
{
    SdfPath materialId;
...
/*virtual*/
VtValue 
LoFiTestDelegate::GetMaterialResource(SdfPath const &materialId)
{
...
/*virtual*/
VtValue
LoFiTestDelegate::GetCameraParamValue(SdfPath const &cameraId, 
...
LoFiTestDelegate::GetTextureResourceID(SdfPath const& textureId)
{
...
LoFiTestDelegate::GetTextureResource(SdfPath const& textureId)
{
    return nullptr;
}
...
LoFiTestDelegate::GetRenderBufferDescriptor(SdfPath const& id)
{
...
/*virtual*/
GfMatrix4d
LoFiTestDelegate::GetTransform(SdfPath const& id)
{
    HD_TRACE_FUNCTION();
...
/*virtual*/
bool
LoFiTestDelegate::GetVisible(SdfPath const& id)
{
    HD_TRACE_FUNCTION();
...
/*virtual*/
VtValue
LoFiTestDelegate::Get(SdfPath const& id, TfToken const& key)
{
    HD_TRACE_FUNCTION();
...
/* virtual */
HdReprSelector
LoFiTestDelegate::GetReprSelector(SdfPath const &id)
{
    HD_TRACE_FUNCTION();
...
LoFiTestDelegate::GetPrimvarDescriptors(SdfPath const& id,
...
void
LoFiTestDelegate::AddCube(SdfPath const &id, GfMatrix4f const &transform, bool guide,
...
void
LoFiTestDelegate::AddGrid(SdfPath const &id, int nx, int ny,
                             GfMatrix4f const &transform,
...
void
LoFiTestDelegate::AddGridWithCustomColor(SdfPath const &id, int nx, int ny,
                                           GfMatrix4f const &transform,
                                           VtValue const &color,
                                           HdInterpolation  colorInterpolation,
                                           bool rightHanded, bool doubleSided,
...
void
LoFiTestDelegate::AddGridWithFaceColor(SdfPath const &id, int nx, int ny,
                                          GfMatrix4f const &transform,
                                          bool rightHanded, bool doubleSided,
                                          SdfPath const &instancerId)
{
...
void
LoFiTestDelegate::AddGridWithVertexColor(SdfPath const &id, int nx, int ny,
                                            GfMatrix4f const &transform,
                                            bool rightHanded, bool doubleSided,
                                            SdfPath const &instancerId)
{
...
void
LoFiTestDelegate::AddGridWithFaceVaryingColor(SdfPath const &id, int nx, int ny,
                                                 GfMatrix4f const &transform,
                                                 bool rightHanded, bool doubleSided,
                                                 SdfPath const &instancerId)
{
...
void
LoFiTestDelegate::AddSubdiv(SdfPath const &id, GfMatrix4f const &transform,
                               SdfPath const &instancerId)
{
/*
...
void
LoFiTestDelegate::Remove(SdfPath const &id)
{
    GetRenderIndex().RemoveRprim(id);
}

void
LoFiTestDelegate::Clear()
{
    GetRenderIndex().Clear();
}

void
LoFiTestDelegate::MarkRprimDirty(SdfPath path, HdDirtyBits flag)
{
    GetRenderIndex().GetChangeTracker().MarkRprimDirty(path, flag);
}

GfVec3f
LoFiTestDelegate::PopulateBasicTestSet()
{
    GfMatrix4d dmat;
    double xPos = 0.0;
...
GfVec3f
LoFiTestDelegate::PopulateInvalidPrimsSet()
{
    // empty mesh
...
VtValue
LoFiTestDelegate::_GetPrimvarValue(SdfPath const& id, TfToken const& name)
{
    _Primvars::iterator pvIt;
    if (_FindPrimvar(id, name, &pvIt)) {
        return pvIt->value;
...
bool
LoFiTestDelegate::_FindPrimvar(SdfPath const& id,
                                 TfToken const& name,
                                 _Primvars::iterator *pvIt)
{
    ...
    LoFiTestDelegate::_Primvars::iterator it2 =
