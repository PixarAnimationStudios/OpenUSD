...
// unlicensed
//
#ifndef PXR_IMAGING_PLUGIN_LOFI_VERTEX_CHANNEL_H
#define PXR_IMAGING_PLUGIN_LOFI_VERTEX_CHANNEL_H
...
enum LoFiVertexChannelChannel : short {
  CHANNEL_POSITION,
  CHANNEL_NORMAL,
  CHANNEL_COLOR,
  CHANNEL_UVS
...
public:
  // constructor
  LoFiVertexChannel( LoFiVertexChannelChannel channel, 
...
#endif // PXR_IMAGING_PLUGIN_LOFI_VERTEX_CHANNEL_H
