...
//
#ifndef EXTRAS_IMAGING_EXAMPLES_HD_LoFi_RENDERER_PLUGIN_H
#define EXTRAS_IMAGING_EXAMPLES_HD_LoFi_RENDERER_PLUGIN_H
...
#endif // EXTRAS_IMAGING_EXAMPLES_HD_LoFi_RENDERER_PLUGIN_H
