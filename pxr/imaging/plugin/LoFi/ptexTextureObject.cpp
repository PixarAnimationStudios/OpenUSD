...
bool LoFiIsSupportedPtexTexture(std::string const & imageFilePath)
{
#ifdef PXR_PTEX_SUPPORT_ENABLED
...
LoFiPtexTextureObject::LoFiPtexTextureObject(
...
void
LoFiPtexTextureObject::_DestroyTextures()
{
    if (Hgi * hgi = _GetHgi()) {
        if (_texelTexture) {
...
void
LoFiPtexTextureObject::_Load()
{
    TRACE_FUNCTION();

    _DestroyTextures();

    TRACE_SCOPE("LoFiPtexTextureObject::_Load() (read ptex)");
    ...
    TRACE_SCOPE("LoFiPtexTextureObject::_Load() (generate texture)");
...
bool
LoFiPtexTextureObject::IsValid() const
{
...
HdTextureType
LoFiPtexTextureObject::GetTextureType() const
{
