...
// Unlicensed
//
#ifndef LOFI_PTEX_MIPMAP_TEXTURE_LOADER_H
#define LOFI_PTEX_MIPMAP_TEXTURE_LOADER_H
...
class LoFiPtexMipmapTextureLoader final
{
public:
    LOFI_API
    LoFiPtexMipmapTextureLoader(PtexTexture *ptex,
                                int maxNumPages,
                                int maxLevels = -1,
...
private:
    struct Block {
        ...
        void guttering(LoFiPtexMipmapTextureLoader *loader, PtexTexture *ptex,
...
#endif // LOFI_PTEX_MIPMAP_TEXTURE_LOADER_H
