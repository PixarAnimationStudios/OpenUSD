...
void
LoFiPtexMipmapTextureLoader::Block::guttering(
    LoFiPtexMipmapTextureLoader *loader,
...
void
LoFiPtexMipmapTextureLoader::Block::Generate(
    LoFiPtexMipmapTextureLoader *loader,
    PtexTexture *ptex,
...
void
LoFiPtexMipmapTextureLoader::Block::SetSize(unsigned char ulog2_,
...
struct LoFiPtexMipmapTextureLoader::Page
{
    struct SlotLimit
    {
    ...
    void Generate(LoFiPtexMipmapTextureLoader *loader, PtexTexture *ptex,
                  unsigned char *destination,
...
class LoFiPtexMipmapTextureLoader::CornerIterator
{
public:
...
LoFiPtexMipmapTextureLoader::LoFiPtexMipmapTextureLoader(PtexTexture *ptex,
                                                         int maxNumPages,
                                                         int maxLevels,
                                                         size_t targetMemory,
                                                         bool seamlessMipmap) :
...
LoFiPtexMipmapTextureLoader::~LoFiPtexMipmapTextureLoader()
{
...
//
int
LoFiPtexMipmapTextureLoader::resampleBorder(int face, int edgeId,
...
void
LoFiPtexMipmapTextureLoader::sampleNeighbor(unsigned char *border, int face,
...
//
bool
LoFiPtexMipmapTextureLoader::getCornerPixel(float *resultPixel, int numchannels,
                                            int face, int edge,
                                            int8_t reslog2)
{
    const Ptex::FaceInfo &fi = _ptex->getFaceInfo(face);
...
int
LoFiPtexMipmapTextureLoader::getLevelDiff(int face, int edge)
{
...
void
LoFiPtexMipmapTextureLoader::optimizePacking(int maxNumPages,
                                             size_t targetMemory)
{
    size_t numTexels = 0;
...
void
LoFiPtexMipmapTextureLoader::generateBuffers()
{
    // ptex layout struct
    // struct Layout {
    //     uint16_t page;
