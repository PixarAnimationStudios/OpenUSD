...
// unlicensed
//
#ifndef PXR_IMAGING_PLUGIN_LOFI_VERTEX_RANGE_H
#define PXR_IMAGING_PLUGIN_LOFI_VERTEX_RANGE_H
...
enum LoFiVertexRangeChannel : short {
  CHANNEL_POSITION,
  CHANNEL_NORMAL,
  CHANNEL_COLOR,
  CHANNEL_UVS
...
enum LoFiVertexRangeState : short {
  INVALID,
  TO_REALLOCATE,
  TO_UPDATE,
  TO_RECYCLE
...
typedef boost::shared_ptr<class LoFiVertexRange> LoFiVertexRangeSharedPtr;
typedef std::vector<LoFiVertexRangeSharedPtr> LoFiVertexRangeSharedPtrList;
typedef std::map<LoFiVertexRangeChannel, LoFiVertexRangeSharedPtr> 
  LoFiVertexRangeSharedPtrMap;

/// \class LoFiVertexRange
///
///
class LoFiVertexRange
{
public:
  // constructor
  LoFiVertexRange( LoFiVertexRangeChannel channel, 
...
#endif // PXR_IMAGING_PLUGIN_LOFI_VERTEX_RANGE_H
