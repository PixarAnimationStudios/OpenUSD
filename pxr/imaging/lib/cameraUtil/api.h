...
//
#ifndef CAMERAUTIL_API_H
#define CAMERAUTIL_API_H
...
#       define CAMERAUTIL_API_TEMPLATE_CLASS(...) extern template class CAMERAUTIL_API __VA_ARGS__
#       define CAMERAUTIL_API_TEMPLATE_STRUCT(...) extern template struct CAMERAUTIL_API __VA_ARGS__
#   endif
