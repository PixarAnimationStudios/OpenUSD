...
public:
    ...
    ///
    GAL_API GalDelegate *GetGalDelegate(const TfToken &delegateId);
...
private:
    ...
    GAL_API GalDelegateRegistry();
    GAL_API virtual ~GalDelegateRegistry();
