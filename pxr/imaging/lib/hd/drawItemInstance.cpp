...
HdDrawItemInstance::~HdDrawItemInstance()
{
}

void
HdDrawItemInstance::SetVisible(bool visible)
{
    _visible = visible;
    if(_batch) {
...
void
HdDrawItemInstance::SetBatchIndex(size_t batchIndex)
{
    _batchIndex = batchIndex;
}

void
HdDrawItemInstance::SetBatch(Hd_DrawBatch *batch)
{
    _batch = batch;
}
