...
#       define PXOSD_API_TEMPLATE_CLASS(...) extern template class PXOSD_API __VA_ARGS__
#       define PXOSD_API_TEMPLATE_STRUCT(...) extern template struct PXOSD_API __VA_ARGS__
#   endif
