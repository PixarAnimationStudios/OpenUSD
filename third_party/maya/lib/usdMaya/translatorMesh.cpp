        ...
        PxrUsdMayaPrimReaderContext* context)
{
    ...
    TF_FOR_ALL(iter, primvars) {
        ...
        if (name == PxrUsdMayaMeshColorSetTokens->DisplayColorColorSetName or
                name == PxrUsdMayaMeshColorSetTokens->DisplayOpacityColorSetName) {
            if (not PxrUsdMayaUtil::GetBoolCustomData(primvar.GetAttr(),
        ...
        } else if (typeName == SdfValueTypeNames->FloatArray or
                   typeName == SdfValueTypeNames->Float3Array or
                   typeName == SdfValueTypeNames->Color3fArray or
                   typeName == SdfValueTypeNames->Float4Array or
                   typeName == SdfValueTypeNames->Color4fArray) {
            if (not _AssignColorSetPrimvarToMesh(mesh, primvar, meshFn)) {
                MGlobal::displayWarning(
