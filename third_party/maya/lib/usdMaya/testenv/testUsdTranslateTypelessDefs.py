...
class testUsdTranslateTypelessDefs(unittest.TestCase):
    ...
    def testImport(self):
        ...
        # XXX: make this Scope after the Scope change
        self.assertEqual(cmds.getAttr('|A|A_1|A_1_III.USD_typeName'), '')
        ...
        # XXX: make this Scope after the Scope change
        self.assertEqual(cmds.getAttr('|A|A_2.USD_typeName'), '')
    ...
    def testReexport(self):
        ...
        # XXX: make this Scope after the Scope change
        self.assertEqual(stage.GetPrimAtPath('/A/A_2').GetTypeName(), '')
