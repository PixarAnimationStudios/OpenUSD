...
//Last modified: Mon, Aug 22, 2016 05:44:05 PM
//Codeset: UTF-8
requires maya "2016";
...
createNode mesh -n "CompressibleUVSetsCubeShape" -p "CompressibleUVSetsCube";
	...
	setAttr ".uvst[1].uvsp[0]" -type "float2" 0.25 0.25;
	setAttr ".uvst[2].uvsn" -type "string" "UniformInterpSet";
	setAttr -s 6 ".uvst[2].uvsp[0:5]" -type "float2" 0 0 0.1 0.1 0.2 0.2
		 0.30000001 0.30000001 0.40000001 0.40000001 0.5 0.5;
...
createNode mesh -n "SharedFacesCubeShape" -p "SharedFacesCube";
	...
	setAttr -s 8 ".uvst[1].uvsp[0:7]" -type "float2" 0 0 0.5 0 0.5 0.5
		 0 0.5 0.5 0.5 1 0.5 1 1 0.5 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6BB5D8C0-0000-562B-57BB-87FA0000025B";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "6BB5D8C0-0000-562B-57BB-87FA0000025C";
	setAttr -s 4 ".dli[1:3]"  1 2 3;
	setAttr -s 4 ".dli";
createNode displayLayer -n "defaultLayer";
	rename -uid "109AE860-0000-148A-5708-3ED200000251";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6BB5D8C0-0000-562B-57BB-87FA0000025E";
