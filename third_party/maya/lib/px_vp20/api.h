...
#       define PX_VP20_API_TEMPLATE_CLASS(...) extern template class PX_VP20_API __VA_ARGS__
#       define PX_VP20_API_TEMPLATE_STRUCT(...) extern template struct PX_VP20_API __VA_ARGS__
#   endif
