...
struct HdxPrman_InteractiveContext : public HdPrman_Context
{
    ...
    // Checks whether context was successfully initialized.  ie. riley was created
    bool IsValid() const;
...
private:
    // Initialize things, like riley, that need to succeed in order for Begin to be called.
    void _Initialize();
