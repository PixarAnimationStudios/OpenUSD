...
//
#ifndef HDPRMAN_GPRIM_H
#define HDPRMAN_GPRIM_H
                          ...
                          TfToken const    &reprToken)
{
    ...
    std::vector<riley::MaterialId> subsetMaterialIds;
    {
        ...
        _ConvertGeometry(context, mgr, sceneDelegate, id,
                         &primType, &geomSubsets, primvars);
    ...
    if (!isHdInstance) {
        ...
        instancerAttrs->SetInteger(RixStr.k_identifier_id, primId);
