...
function(_pxr_enable_precompiled_header TARGET_NAME)
    ...
    foreach(source ${target_sources})
        ...
        if(source MATCHES \\.cpp$)
            if (NOT "${source}" IN_LIST pch_EXCLUDE)
...
function(_pxr_library NAME)
    ...
    if(NOT args_TYPE STREQUAL "STATIC")
        if(NOT ("${NAME}" IN_LIST PXR_CORE_LIBS AND _building_monolithic))
            file(RELATIVE_PATH
                pluginToLibraryPath
