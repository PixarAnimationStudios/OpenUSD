...
# Add a python module target named NAME.  It implicitly links against the
# library named NAME.
function(_pxr_python_module NAME)
    ...
    if (args_PYSIDE_UI_FILES)
        _install_pyside_ui_files(${args_PYSIDE_UI_FILES})
    endif()        
