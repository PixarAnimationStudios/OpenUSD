...
if (PXR_BUILD_IMAGING)
    ...
    if (PXR_BUILD_OPENIMAGEIO_PLUGIN)
        ...
        if (OpenImageIO_FOUND)
            get_target_property(OIIO_INCS OpenImageIO::OpenImageIO INTERFACE_INCLUDE_DIRECTORIES)
            set(OIIO_INCLUDE_DIRS ${OIIO_INCS} CACHE STRING "")
            set(OIIO_LIBRARIES OpenImageIO::OpenImageIO CACHE STRING "")
            set(OIIO_VERSION "${OpenImageIO_VERSION_MAJOR}.${OpenImageIO_VERSION_MINOR}.${OpenImageIO_VERSION_PATCH}" CACHE STRING "")
        else ()
        ...
        elseif (PXR_BUILD_TESTS)
            message(WARNING "idiff based tests won't succeed as idiff not found.")
        endif()
    endif()
    # --OpenColorIO
    ...
    # TODO: Remove in a future version. Nothing internal depends on it anymore.
...
if(REQUIRES_Imath)
    ...
    if (NOT Imath_FOUND)
        ...
        if (OpenEXR_FOUND)
            get_target_property(OPENEXR_INCS OpenEXR::OpenEXR INTERFACE_INCLUDE_DIRECTORIES)
            set(OPENEXR_INCLUDE_DIRS ${OPENEXR_INCS} CACHE STRING "")
            set(OPENEXR_LIBRARIES OpenEXR::OpenEXR CACHE STRING "")
            set(OPENEXR_VERSION "${OpenEXR_VERSION_MAJOR}.${OpenEXR_VERSION_MINOR}.${OpenEXR_VERSION_PATCH}" CACHE STRING "")
