...
if (PXR_BUILD_IMAGING)
    ...
    if(OpenSubdiv_DIR)
        ...
        endforeach()
        file(GLOB osdfiles ${OpenSubdiv_DIR}/*)
        foreach(osdfile IN LISTS osdfiles)
            message(STATUS "BEGIN OSDFILE: ${osdfile}")
            file(READ ${osdfile} osdfilecontents)
            message(STATUS "${osdfilecontents}")
            message(STATUS "END OSDFILE ${osdfile}")
        endforeach()
    else()
