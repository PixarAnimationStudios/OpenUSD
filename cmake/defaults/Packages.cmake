...
if (PXR_BUILD_IMAGING)
    ...
    if(OpenSubdiv_DIR)
        # First check shared, then static library, just like find_library() in FindOpenSubdiv.cmake.
        foreach(postfix "" "_static")
            ...
            foreach(i IN LISTS ${OPENSUBDIV_LIBRARIES})
                if(NOT TARGET ${i})
    ...
    if(OPENSUBDIV_LIBRARIES)
        ...
        message(STATUS "OPENSUBDIV_OSDCPU_LIBRARY: ${OPENSUBDIV_OSDCPU_LIBRARY}")
    else()
        find_package(OpenSubdiv 3 REQUIRED)
        message(STATUS "OpenSubdiv found as module")
        message(STATUS "1 ${OPENSUBDIV_LIBRARIES}")
        message(STATUS "2 ${OPENSUBDIV_OSDCPU_LIBRARY}")
    endif()
    # --Ptex
