...
:ref:`UsdUVTexture's<wp_usdpreviewsurface:texture reader>` :usda:`rgb` output of
...
* **st - float2 - (0.0, 0.0)** 
  ...
  **upper-right-hand corner** of the texture image, as viewed on a monitor. See
  :ref:`wp_usdpreviewsurface:texture coordinate orientation in usd` for more
  details.
...
:ref:`Texture Reader node<wp_usdpreviewsurface:texture reader>` . The coordinate
...
From version 2.0...
    ...
    * Adds :ref:`wp_usdpreviewsurface:transform2d`
