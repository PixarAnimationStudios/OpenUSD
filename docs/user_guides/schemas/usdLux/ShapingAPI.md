...
% Generated: 01:34PM on December 03, 2025
...
product between the light's primary axis and the emission direction, raised to 
...
```{math}
\begin{aligned} 
&focusFactor = ｜emissionDirection • lightAxis｜^{focus} \\
