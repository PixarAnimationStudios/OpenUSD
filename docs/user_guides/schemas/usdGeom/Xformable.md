...
### Complex Transform with Pivot
```{code-block} usda
#usda 1.0

def Xform "PivotTransform"
{
    double3 xformOp:translate = (5, 0, 0)
    double3 xformOp:translate:pivot = (2, 0, 0)
    double3 xformOp:rotateXYZ = (0, 45, 0)
...
4. **Animation**:
   ...
   - Avoid animating individual components when possible
   - Consider using quaternions for smooth rotation interpolation

5. **Hierarchy**:
   - Use Xform prims to group related geometry
