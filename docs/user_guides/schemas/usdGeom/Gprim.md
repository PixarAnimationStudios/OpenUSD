...
```
![transparent sphere in usdview](./transparent_sphere.png)
...
```
![animated displayColor in usdview](./animated_display_color.gif)

## Best Practices
1. **Extent Management**:
   - Always provide authored extents to avoid expensive runtime extent computation.
